...
{ time x265  --aud --slow-firstpass --no-weightb --aq-strength 2.0 --ipratio 1.6 --pbratio 1.2 --psy-rd 2.2 --qblur 0.5 --qcomp 0.9 --vbv-init 0.1 --aq-mode 1 --b-adapt 1 --bframes 16 --crf 20 --keyint 300 --lookahead-threads 1 --min-keyint 21 --qp 30 --qpstep 4 --qpmin 1 --qpmax 65 --rc-lookahead 28 --ref 4 --vbv-bufsize 1000 --deblock -2:-2 --me umh --overscan crop --preset slow --scenecut 10 --tune ssim --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
