...
{ time x265  --no-asm --no-weightb --aq-strength 0.0 --ipratio 1.6 --pbratio 1.1 --psy-rd 3.2 --qblur 0.5 --qcomp 0.8 --vbv-init 0.1 --aq-mode 3 --b-adapt 2 --bframes 2 --crf 25 --keyint 270 --lookahead-threads 1 --min-keyint 28 --qp 50 --qpstep 4 --qpmin 3 --qpmax 61 --rc-lookahead 18 --ref 4 --vbv-bufsize 1000 --deblock 1:1 --me hex --overscan show --preset medium --scenecut 30 --tune grain --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
