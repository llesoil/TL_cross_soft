...
{ time x265  --aud --constrained-intra --no-asm --weightb --aq-strength 3.0 --ipratio 1.5 --pbratio 1.4 --psy-rd 2.0 --qblur 0.4 --qcomp 0.6 --vbv-init 0.2 --aq-mode 3 --b-adapt 2 --bframes 8 --crf 35 --keyint 300 --lookahead-threads 2 --min-keyint 27 --qp 50 --qpstep 4 --qpmin 3 --qpmax 61 --rc-lookahead 38 --ref 5 --vbv-bufsize 2000 --deblock 1:1 --me hex --overscan show --preset superfast --scenecut 10 --tune psnr --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
