...
{ time x265  --aud --no-weightb --aq-strength 0.0 --ipratio 1.3 --pbratio 1.0 --psy-rd 3.0 --qblur 0.5 --qcomp 0.6 --vbv-init 0.8 --aq-mode 1 --b-adapt 1 --bframes 2 --crf 40 --keyint 300 --lookahead-threads 1 --min-keyint 20 --qp 20 --qpstep 3 --qpmin 2 --qpmax 60 --rc-lookahead 18 --ref 5 --vbv-bufsize 2000 --deblock -2:-2 --me dia --overscan show --preset veryslow --scenecut 30 --tune psnr --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
