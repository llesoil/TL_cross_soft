...
{ time x265  --aud --no-weightb --aq-strength 2.0 --ipratio 1.6 --pbratio 1.3 --psy-rd 3.6 --qblur 0.6 --qcomp 0.9 --vbv-init 0.4 --aq-mode 2 --b-adapt 0 --bframes 0 --crf 40 --keyint 270 --lookahead-threads 1 --min-keyint 22 --qp 30 --qpstep 3 --qpmin 3 --qpmax 65 --rc-lookahead 28 --ref 1 --vbv-bufsize 1000 --deblock 1:1 --me dia --overscan crop --preset slow --scenecut 0 --tune animation --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
