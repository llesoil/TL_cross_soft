...
{ time x265  --aud --constrained-intra --weightb --aq-strength 1.5 --ipratio 1.5 --pbratio 1.2 --psy-rd 3.4 --qblur 0.4 --qcomp 0.6 --vbv-init 0.2 --aq-mode 3 --b-adapt 2 --bframes 16 --crf 20 --keyint 260 --lookahead-threads 1 --min-keyint 24 --qp 40 --qpstep 3 --qpmin 1 --qpmax 68 --rc-lookahead 38 --ref 2 --vbv-bufsize 2000 --deblock 1:1 --me umh --overscan crop --preset veryfast --scenecut 10 --tune ssim --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
