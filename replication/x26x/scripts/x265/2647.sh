...
{ time x265  --aud --constrained-intra --no-asm --weightb --aq-strength 1.5 --ipratio 1.3 --pbratio 1.2 --psy-rd 2.8 --qblur 0.4 --qcomp 0.9 --vbv-init 0.1 --aq-mode 0 --b-adapt 2 --bframes 14 --crf 40 --keyint 200 --lookahead-threads 4 --min-keyint 21 --qp 50 --qpstep 5 --qpmin 2 --qpmax 67 --rc-lookahead 28 --ref 6 --vbv-bufsize 2000 --deblock 1:1 --me dia --overscan crop --preset superfast --scenecut 30 --tune animation --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
