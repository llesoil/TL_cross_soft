...
{ time x265  --constrained-intra --no-asm --no-weightb --aq-strength 2.5 --ipratio 1.3 --pbratio 1.2 --psy-rd 2.0 --qblur 0.6 --qcomp 0.9 --vbv-init 0.9 --aq-mode 3 --b-adapt 1 --bframes 16 --crf 40 --keyint 220 --lookahead-threads 2 --min-keyint 26 --qp 10 --qpstep 5 --qpmin 1 --qpmax 60 --rc-lookahead 48 --ref 3 --vbv-bufsize 1000 --deblock 1:1 --me umh --overscan crop --preset ultrafast --scenecut 40 --tune grain --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
