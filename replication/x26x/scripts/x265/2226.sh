...
{ time x265  --constrained-intra --no-weightb --aq-strength 2.0 --ipratio 1.6 --pbratio 1.4 --psy-rd 3.2 --qblur 0.2 --qcomp 0.6 --vbv-init 0.8 --aq-mode 1 --b-adapt 2 --bframes 10 --crf 50 --keyint 300 --lookahead-threads 1 --min-keyint 26 --qp 30 --qpstep 5 --qpmin 1 --qpmax 63 --rc-lookahead 28 --ref 4 --vbv-bufsize 2000 --deblock -2:-2 --me dia --overscan show --preset medium --scenecut 10 --tune grain --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
