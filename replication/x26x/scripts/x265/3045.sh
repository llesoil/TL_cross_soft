...
{ time x265  --constrained-intra --slow-firstpass --no-weightb --aq-strength 1.5 --ipratio 1.0 --pbratio 1.0 --psy-rd 0.2 --qblur 0.5 --qcomp 0.8 --vbv-init 0.3 --aq-mode 0 --b-adapt 0 --bframes 6 --crf 35 --keyint 270 --lookahead-threads 4 --min-keyint 20 --qp 40 --qpstep 4 --qpmin 1 --qpmax 61 --rc-lookahead 28 --ref 6 --vbv-bufsize 2000 --deblock 1:1 --me umh --overscan crop --preset superfast --scenecut 40 --tune psnr --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
