...
{ time x265  --aud --constrained-intra --no-asm --weightb --aq-strength 0.5 --ipratio 1.1 --pbratio 1.1 --psy-rd 2.2 --qblur 0.2 --qcomp 0.8 --vbv-init 0.5 --aq-mode 1 --b-adapt 1 --bframes 6 --crf 20 --keyint 270 --lookahead-threads 2 --min-keyint 25 --qp 50 --qpstep 3 --qpmin 4 --qpmax 63 --rc-lookahead 18 --ref 5 --vbv-bufsize 2000 --deblock -1:-1 --me dia --overscan crop --preset veryfast --scenecut 30 --tune animation --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
