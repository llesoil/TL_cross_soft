...
{ time x265  --slow-firstpass --no-weightb --aq-strength 0.5 --ipratio 1.2 --pbratio 1.4 --psy-rd 2.4 --qblur 0.5 --qcomp 0.8 --vbv-init 0.1 --aq-mode 3 --b-adapt 1 --bframes 2 --crf 10 --keyint 280 --lookahead-threads 1 --min-keyint 21 --qp 0 --qpstep 5 --qpmin 4 --qpmax 60 --rc-lookahead 18 --ref 2 --vbv-bufsize 2000 --deblock -1:-1 --me hex --overscan crop --preset faster --scenecut 30 --tune ssim --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
