...
{ time x265  --aud --no-weightb --aq-strength 0.0 --ipratio 1.3 --pbratio 1.2 --psy-rd 2.0 --qblur 0.3 --qcomp 0.9 --vbv-init 0.0 --aq-mode 0 --b-adapt 2 --bframes 10 --crf 35 --keyint 290 --lookahead-threads 4 --min-keyint 20 --qp 50 --qpstep 4 --qpmin 2 --qpmax 61 --rc-lookahead 48 --ref 6 --vbv-bufsize 2000 --deblock -2:-2 --me dia --overscan crop --preset placebo --scenecut 40 --tune animation --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
