...
{ time x265  --aud --constrained-intra --no-asm --weightb --aq-strength 0.5 --ipratio 1.4 --pbratio 1.1 --psy-rd 3.6 --qblur 0.4 --qcomp 0.6 --vbv-init 0.2 --aq-mode 1 --b-adapt 2 --bframes 8 --crf 40 --keyint 270 --lookahead-threads 2 --min-keyint 24 --qp 20 --qpstep 5 --qpmin 4 --qpmax 65 --rc-lookahead 28 --ref 1 --vbv-bufsize 2000 --deblock 1:1 --me umh --overscan show --preset veryslow --scenecut 30 --tune animation --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
