...
{ time x265  --aud --constrained-intra --intra-refresh --no-asm --weightb --aq-strength 3.0 --ipratio 1.2 --pbratio 1.1 --psy-rd 4.6 --qblur 0.3 --qcomp 0.9 --vbv-init 0.1 --aq-mode 1 --b-adapt 1 --bframes 4 --crf 0 --keyint 260 --lookahead-threads 4 --min-keyint 30 --qp 30 --qpstep 5 --qpmin 4 --qpmax 69 --rc-lookahead 38 --ref 1 --vbv-bufsize 2000 --deblock 1:1 --me dia --overscan show --preset placebo --scenecut 0 --tune grain --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
