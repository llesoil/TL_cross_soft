...
{ time x265  --constrained-intra --no-asm --slow-firstpass --no-weightb --aq-strength 0.0 --ipratio 1.5 --pbratio 1.0 --psy-rd 0.2 --qblur 0.6 --qcomp 0.8 --vbv-init 0.1 --aq-mode 3 --b-adapt 2 --bframes 4 --crf 45 --keyint 200 --lookahead-threads 2 --min-keyint 29 --qp 10 --qpstep 4 --qpmin 1 --qpmax 61 --rc-lookahead 18 --ref 4 --vbv-bufsize 2000 --deblock 1:1 --me umh --overscan crop --preset veryfast --scenecut 0 --tune grain --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
