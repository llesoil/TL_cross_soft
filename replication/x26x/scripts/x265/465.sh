...
{ time x265  --no-asm --weightb --aq-strength 0.0 --ipratio 1.3 --pbratio 1.4 --psy-rd 3.2 --qblur 0.6 --qcomp 0.8 --vbv-init 0.4 --aq-mode 0 --b-adapt 2 --bframes 14 --crf 20 --keyint 280 --lookahead-threads 0 --min-keyint 21 --qp 50 --qpstep 5 --qpmin 2 --qpmax 65 --rc-lookahead 48 --ref 4 --vbv-bufsize 1000 --deblock 1:1 --me hex --overscan show --preset placebo --scenecut 40 --tune psnr --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
