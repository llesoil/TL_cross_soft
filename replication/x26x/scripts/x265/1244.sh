...
{ time x265  --aud --no-asm --slow-firstpass --no-weightb --aq-strength 1.5 --ipratio 1.5 --pbratio 1.4 --psy-rd 3.0 --qblur 0.5 --qcomp 0.6 --vbv-init 0.2 --aq-mode 0 --b-adapt 1 --bframes 14 --crf 15 --keyint 220 --lookahead-threads 0 --min-keyint 20 --qp 50 --qpstep 3 --qpmin 2 --qpmax 61 --rc-lookahead 48 --ref 1 --vbv-bufsize 2000 --deblock -2:-2 --me dia --overscan show --preset ultrafast --scenecut 40 --tune grain --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
