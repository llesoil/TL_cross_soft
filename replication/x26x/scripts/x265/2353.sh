...
{ time x265  --aud --no-asm --no-weightb --aq-strength 0.0 --ipratio 1.0 --pbratio 1.3 --psy-rd 2.4 --qblur 0.3 --qcomp 0.8 --vbv-init 0.6 --aq-mode 2 --b-adapt 0 --bframes 16 --crf 40 --keyint 290 --lookahead-threads 3 --min-keyint 29 --qp 30 --qpstep 4 --qpmin 0 --qpmax 62 --rc-lookahead 38 --ref 5 --vbv-bufsize 2000 --deblock -1:-1 --me hex --overscan show --preset slow --scenecut 40 --tune psnr --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
