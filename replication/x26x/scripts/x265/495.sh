...
{ time x265  --aud --no-asm --no-weightb --aq-strength 0.5 --ipratio 1.2 --pbratio 1.3 --psy-rd 4.2 --qblur 0.2 --qcomp 0.6 --vbv-init 0.3 --aq-mode 1 --b-adapt 1 --bframes 10 --crf 50 --keyint 220 --lookahead-threads 0 --min-keyint 28 --qp 10 --qpstep 5 --qpmin 1 --qpmax 66 --rc-lookahead 48 --ref 2 --vbv-bufsize 1000 --deblock 1:1 --me dia --overscan crop --preset medium --scenecut 30 --tune ssim --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
