...
{ time x265  --constrained-intra --weightb --aq-strength 0.5 --ipratio 1.0 --pbratio 1.3 --psy-rd 3.4 --qblur 0.2 --qcomp 0.9 --vbv-init 0.5 --aq-mode 2 --b-adapt 0 --bframes 10 --crf 20 --keyint 300 --lookahead-threads 4 --min-keyint 28 --qp 50 --qpstep 4 --qpmin 1 --qpmax 63 --rc-lookahead 28 --ref 2 --vbv-bufsize 2000 --deblock -2:-2 --me umh --overscan crop --preset faster --scenecut 0 --tune grain --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
