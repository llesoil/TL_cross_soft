...
{ time x265  --aud --slow-firstpass --no-weightb --aq-strength 3.0 --ipratio 1.5 --pbratio 1.4 --psy-rd 3.4 --qblur 0.3 --qcomp 0.6 --vbv-init 0.9 --aq-mode 0 --b-adapt 0 --bframes 6 --crf 40 --keyint 200 --lookahead-threads 2 --min-keyint 21 --qp 30 --qpstep 4 --qpmin 0 --qpmax 62 --rc-lookahead 38 --ref 4 --vbv-bufsize 2000 --deblock -1:-1 --me dia --overscan crop --preset veryfast --scenecut 30 --tune psnr --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
