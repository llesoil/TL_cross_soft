...
{ time x265  --weightb --aq-strength 2.5 --ipratio 1.1 --pbratio 1.1 --psy-rd 2.6 --qblur 0.4 --qcomp 0.9 --vbv-init 0.5 --aq-mode 3 --b-adapt 1 --bframes 6 --crf 40 --keyint 270 --lookahead-threads 0 --min-keyint 29 --qp 50 --qpstep 4 --qpmin 1 --qpmax 64 --rc-lookahead 18 --ref 3 --vbv-bufsize 1000 --deblock -2:-2 --me dia --overscan show --preset slower --scenecut 10 --tune animation --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
