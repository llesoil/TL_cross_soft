...
{ time x265  --constrained-intra --no-weightb --aq-strength 3.0 --ipratio 1.3 --pbratio 1.4 --psy-rd 3.8 --qblur 0.2 --qcomp 0.9 --vbv-init 0.3 --aq-mode 0 --b-adapt 1 --bframes 8 --crf 15 --keyint 300 --lookahead-threads 0 --min-keyint 21 --qp 30 --qpstep 3 --qpmin 2 --qpmax 60 --rc-lookahead 28 --ref 5 --vbv-bufsize 1000 --deblock -2:-2 --me umh --overscan show --preset veryslow --scenecut 40 --tune ssim --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
