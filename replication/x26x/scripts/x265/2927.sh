...
{ time x265  --no-asm --no-weightb --aq-strength 1.0 --ipratio 1.4 --pbratio 1.3 --psy-rd 4.8 --qblur 0.6 --qcomp 0.9 --vbv-init 0.4 --aq-mode 2 --b-adapt 1 --bframes 0 --crf 10 --keyint 300 --lookahead-threads 2 --min-keyint 29 --qp 50 --qpstep 5 --qpmin 0 --qpmax 65 --rc-lookahead 38 --ref 4 --vbv-bufsize 1000 --deblock 1:1 --me umh --overscan crop --preset faster --scenecut 0 --tune grain --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
