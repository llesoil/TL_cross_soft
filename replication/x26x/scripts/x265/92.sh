...
{ time x265  --aud --slow-firstpass --no-weightb --aq-strength 2.5 --ipratio 1.1 --pbratio 1.1 --psy-rd 4.2 --qblur 0.3 --qcomp 0.6 --vbv-init 0.4 --aq-mode 0 --b-adapt 0 --bframes 4 --crf 40 --keyint 270 --lookahead-threads 1 --min-keyint 30 --qp 50 --qpstep 4 --qpmin 0 --qpmax 66 --rc-lookahead 48 --ref 3 --vbv-bufsize 2000 --deblock 1:1 --me hex --overscan show --preset placebo --scenecut 0 --tune grain --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
