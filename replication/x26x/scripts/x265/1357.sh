...
{ time x265  --no-asm --no-weightb --aq-strength 1.0 --ipratio 1.1 --pbratio 1.4 --psy-rd 0.6 --qblur 0.5 --qcomp 0.8 --vbv-init 0.5 --aq-mode 2 --b-adapt 0 --bframes 12 --crf 25 --keyint 290 --lookahead-threads 1 --min-keyint 27 --qp 30 --qpstep 3 --qpmin 0 --qpmax 62 --rc-lookahead 38 --ref 5 --vbv-bufsize 2000 --deblock -1:-1 --me dia --overscan crop --preset veryfast --scenecut 10 --tune ssim --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
