...
{ time x265  --weightb --aq-strength 1.5 --ipratio 1.6 --pbratio 1.1 --psy-rd 1.4 --qblur 0.5 --qcomp 0.6 --vbv-init 0.3 --aq-mode 3 --b-adapt 1 --bframes 6 --crf 25 --keyint 300 --lookahead-threads 1 --min-keyint 20 --qp 50 --qpstep 3 --qpmin 2 --qpmax 64 --rc-lookahead 38 --ref 5 --vbv-bufsize 2000 --deblock -2:-2 --me hex --overscan crop --preset faster --scenecut 0 --tune grain --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
