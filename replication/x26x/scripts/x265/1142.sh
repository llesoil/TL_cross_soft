...
{ time x265  --no-asm --no-weightb --aq-strength 0.0 --ipratio 1.2 --pbratio 1.2 --psy-rd 0.8 --qblur 0.6 --qcomp 0.8 --vbv-init 0.8 --aq-mode 3 --b-adapt 1 --bframes 16 --crf 25 --keyint 270 --lookahead-threads 4 --min-keyint 28 --qp 0 --qpstep 4 --qpmin 3 --qpmax 60 --rc-lookahead 48 --ref 2 --vbv-bufsize 1000 --deblock -1:-1 --me hex --overscan crop --preset slower --scenecut 40 --tune grain --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
