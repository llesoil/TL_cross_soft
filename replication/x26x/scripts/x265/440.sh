...
{ time x265  --constrained-intra --no-asm --weightb --aq-strength 2.0 --ipratio 1.5 --pbratio 1.2 --psy-rd 2.8 --qblur 0.3 --qcomp 0.9 --vbv-init 0.0 --aq-mode 2 --b-adapt 0 --bframes 6 --crf 25 --keyint 220 --lookahead-threads 2 --min-keyint 22 --qp 30 --qpstep 3 --qpmin 1 --qpmax 62 --rc-lookahead 18 --ref 5 --vbv-bufsize 2000 --deblock -1:-1 --me hex --overscan crop --preset faster --scenecut 30 --tune psnr --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
