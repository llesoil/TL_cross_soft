...
{ time x265  --constrained-intra --no-weightb --aq-strength 2.0 --ipratio 1.1 --pbratio 1.2 --psy-rd 2.4 --qblur 0.2 --qcomp 0.9 --vbv-init 0.3 --aq-mode 1 --b-adapt 0 --bframes 16 --crf 45 --keyint 220 --lookahead-threads 4 --min-keyint 26 --qp 10 --qpstep 5 --qpmin 2 --qpmax 60 --rc-lookahead 38 --ref 2 --vbv-bufsize 2000 --deblock -1:-1 --me hex --overscan crop --preset slower --scenecut 40 --tune grain --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
