...
{ time x265  --aud --slow-firstpass --no-weightb --aq-strength 0.0 --ipratio 1.4 --pbratio 1.1 --psy-rd 2.0 --qblur 0.5 --qcomp 0.6 --vbv-init 0.1 --aq-mode 1 --b-adapt 2 --bframes 6 --crf 0 --keyint 260 --lookahead-threads 2 --min-keyint 27 --qp 20 --qpstep 4 --qpmin 1 --qpmax 69 --rc-lookahead 18 --ref 4 --vbv-bufsize 1000 --deblock -2:-2 --me hex --overscan show --preset slower --scenecut 10 --tune animation --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
