...
{ time x265  --no-asm --weightb --aq-strength 1.0 --ipratio 1.1 --pbratio 1.1 --psy-rd 1.6 --qblur 0.3 --qcomp 0.6 --vbv-init 0.3 --aq-mode 3 --b-adapt 1 --bframes 10 --crf 10 --keyint 200 --lookahead-threads 1 --min-keyint 30 --qp 50 --qpstep 3 --qpmin 0 --qpmax 60 --rc-lookahead 28 --ref 5 --vbv-bufsize 1000 --deblock 1:1 --me hex --overscan crop --preset placebo --scenecut 0 --tune psnr --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
