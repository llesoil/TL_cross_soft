...
{ time x265  --aud --constrained-intra --no-asm --weightb --aq-strength 2.0 --ipratio 1.4 --pbratio 1.2 --psy-rd 2.4 --qblur 0.5 --qcomp 0.8 --vbv-init 0.8 --aq-mode 2 --b-adapt 2 --bframes 4 --crf 20 --keyint 250 --lookahead-threads 1 --min-keyint 26 --qp 50 --qpstep 4 --qpmin 0 --qpmax 63 --rc-lookahead 28 --ref 2 --vbv-bufsize 1000 --deblock -1:-1 --me hex --overscan show --preset slow --scenecut 30 --tune grain --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
