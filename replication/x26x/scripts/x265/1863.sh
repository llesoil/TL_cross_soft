...
{ time x265  --no-weightb --aq-strength 3.0 --ipratio 1.5 --pbratio 1.1 --psy-rd 3.0 --qblur 0.3 --qcomp 0.9 --vbv-init 0.3 --aq-mode 3 --b-adapt 0 --bframes 14 --crf 10 --keyint 220 --lookahead-threads 0 --min-keyint 21 --qp 10 --qpstep 4 --qpmin 1 --qpmax 62 --rc-lookahead 28 --ref 3 --vbv-bufsize 2000 --deblock 1:1 --me umh --overscan crop --preset faster --scenecut 30 --tune ssim --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
