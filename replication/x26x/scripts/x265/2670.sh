...
{ time x265  --aud --no-asm --no-weightb --aq-strength 0.0 --ipratio 1.5 --pbratio 1.1 --psy-rd 4.8 --qblur 0.3 --qcomp 0.9 --vbv-init 0.0 --aq-mode 2 --b-adapt 2 --bframes 0 --crf 5 --keyint 260 --lookahead-threads 0 --min-keyint 30 --qp 30 --qpstep 5 --qpmin 4 --qpmax 66 --rc-lookahead 48 --ref 2 --vbv-bufsize 1000 --deblock -1:-1 --me umh --overscan show --preset veryslow --scenecut 0 --tune animation --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
