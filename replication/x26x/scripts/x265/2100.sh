...
{ time x265  --intra-refresh --weightb --aq-strength 0.0 --ipratio 1.6 --pbratio 1.0 --psy-rd 2.8 --qblur 0.6 --qcomp 0.9 --vbv-init 0.0 --aq-mode 0 --b-adapt 1 --bframes 6 --crf 45 --keyint 300 --lookahead-threads 0 --min-keyint 23 --qp 30 --qpstep 4 --qpmin 1 --qpmax 62 --rc-lookahead 48 --ref 1 --vbv-bufsize 1000 --deblock 1:1 --me umh --overscan crop --preset slower --scenecut 0 --tune psnr --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
