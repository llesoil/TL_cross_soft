...
{ time x265  --aud --no-asm --weightb --aq-strength 2.5 --ipratio 1.4 --pbratio 1.1 --psy-rd 0.2 --qblur 0.5 --qcomp 0.8 --vbv-init 0.4 --aq-mode 2 --b-adapt 0 --bframes 12 --crf 0 --keyint 220 --lookahead-threads 2 --min-keyint 26 --qp 50 --qpstep 5 --qpmin 3 --qpmax 62 --rc-lookahead 38 --ref 4 --vbv-bufsize 1000 --deblock -2:-2 --me hex --overscan show --preset medium --scenecut 0 --tune ssim --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
