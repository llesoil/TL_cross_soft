...
{ time x265  --aud --no-asm --weightb --aq-strength 2.5 --ipratio 1.0 --pbratio 1.2 --psy-rd 2.0 --qblur 0.5 --qcomp 0.9 --vbv-init 0.2 --aq-mode 2 --b-adapt 2 --bframes 8 --crf 40 --keyint 220 --lookahead-threads 2 --min-keyint 21 --qp 10 --qpstep 4 --qpmin 1 --qpmax 65 --rc-lookahead 48 --ref 2 --vbv-bufsize 2000 --deblock -2:-2 --me dia --overscan show --preset superfast --scenecut 40 --tune grain --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
