...
{ time x265  --constrained-intra --no-asm --no-weightb --aq-strength 3.0 --ipratio 1.6 --pbratio 1.1 --psy-rd 2.0 --qblur 0.3 --qcomp 0.6 --vbv-init 0.1 --aq-mode 3 --b-adapt 2 --bframes 10 --crf 0 --keyint 260 --lookahead-threads 2 --min-keyint 30 --qp 10 --qpstep 3 --qpmin 1 --qpmax 63 --rc-lookahead 48 --ref 3 --vbv-bufsize 2000 --deblock -1:-1 --me umh --overscan show --preset medium --scenecut 0 --tune grain --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
