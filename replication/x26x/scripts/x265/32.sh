...
{ time x265  --slow-firstpass --no-weightb --aq-strength 3.0 --ipratio 1.3 --pbratio 1.3 --psy-rd 2.0 --qblur 0.5 --qcomp 0.9 --vbv-init 0.9 --aq-mode 2 --b-adapt 0 --bframes 4 --crf 45 --keyint 300 --lookahead-threads 1 --min-keyint 21 --qp 30 --qpstep 5 --qpmin 4 --qpmax 69 --rc-lookahead 38 --ref 4 --vbv-bufsize 1000 --deblock 1:1 --me umh --overscan show --preset faster --scenecut 30 --tune psnr --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
