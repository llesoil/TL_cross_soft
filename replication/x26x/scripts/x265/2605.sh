...
{ time x265  --aud --slow-firstpass --no-weightb --aq-strength 3.0 --ipratio 1.5 --pbratio 1.0 --psy-rd 4.0 --qblur 0.3 --qcomp 0.8 --vbv-init 0.1 --aq-mode 0 --b-adapt 0 --bframes 6 --crf 35 --keyint 300 --lookahead-threads 1 --min-keyint 27 --qp 50 --qpstep 5 --qpmin 0 --qpmax 64 --rc-lookahead 18 --ref 2 --vbv-bufsize 2000 --deblock -1:-1 --me dia --overscan crop --preset placebo --scenecut 10 --tune psnr --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
