...
{ time x265  --aud --no-asm --weightb --aq-strength 2.5 --ipratio 1.4 --pbratio 1.0 --psy-rd 2.4 --qblur 0.5 --qcomp 0.8 --vbv-init 0.0 --aq-mode 3 --b-adapt 2 --bframes 16 --crf 15 --keyint 250 --lookahead-threads 0 --min-keyint 26 --qp 50 --qpstep 3 --qpmin 0 --qpmax 63 --rc-lookahead 48 --ref 3 --vbv-bufsize 2000 --deblock -2:-2 --me umh --overscan show --preset veryslow --scenecut 0 --tune grain --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
