...
{ time x265  --no-weightb --aq-strength 0.0 --ipratio 1.4 --pbratio 1.2 --psy-rd 3.0 --qblur 0.5 --qcomp 0.8 --vbv-init 0.8 --aq-mode 3 --b-adapt 2 --bframes 10 --crf 15 --keyint 280 --lookahead-threads 1 --min-keyint 27 --qp 30 --qpstep 4 --qpmin 2 --qpmax 65 --rc-lookahead 18 --ref 6 --vbv-bufsize 2000 --deblock 1:1 --me dia --overscan crop --preset slow --scenecut 40 --tune psnr --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
