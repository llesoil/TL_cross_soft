...
{ time x265  --no-asm --weightb --aq-strength 3.0 --ipratio 1.4 --pbratio 1.3 --psy-rd 4.4 --qblur 0.5 --qcomp 0.8 --vbv-init 0.4 --aq-mode 3 --b-adapt 1 --bframes 12 --crf 10 --keyint 300 --lookahead-threads 0 --min-keyint 21 --qp 30 --qpstep 3 --qpmin 3 --qpmax 64 --rc-lookahead 28 --ref 4 --vbv-bufsize 2000 --deblock -1:-1 --me hex --overscan crop --preset medium --scenecut 10 --tune animation --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
