...
{ time x265  --constrained-intra --no-asm --no-weightb --aq-strength 0.0 --ipratio 1.5 --pbratio 1.1 --psy-rd 3.0 --qblur 0.3 --qcomp 0.6 --vbv-init 0.6 --aq-mode 1 --b-adapt 1 --bframes 8 --crf 20 --keyint 250 --lookahead-threads 2 --min-keyint 30 --qp 20 --qpstep 3 --qpmin 1 --qpmax 60 --rc-lookahead 38 --ref 6 --vbv-bufsize 2000 --deblock -2:-2 --me umh --overscan crop --preset superfast --scenecut 30 --tune psnr --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
