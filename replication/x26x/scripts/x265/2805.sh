...
{ time x265  --aud --constrained-intra --no-weightb --aq-strength 1.5 --ipratio 1.3 --pbratio 1.3 --psy-rd 0.8 --qblur 0.4 --qcomp 0.9 --vbv-init 0.8 --aq-mode 0 --b-adapt 2 --bframes 10 --crf 15 --keyint 290 --lookahead-threads 0 --min-keyint 27 --qp 30 --qpstep 3 --qpmin 1 --qpmax 61 --rc-lookahead 28 --ref 1 --vbv-bufsize 1000 --deblock -2:-2 --me hex --overscan show --preset veryslow --scenecut 30 --tune psnr --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
