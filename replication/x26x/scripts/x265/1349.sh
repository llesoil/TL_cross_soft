...
{ time x265  --aud --constrained-intra --no-asm --weightb --aq-strength 3.0 --ipratio 1.1 --pbratio 1.2 --psy-rd 2.8 --qblur 0.4 --qcomp 0.6 --vbv-init 0.5 --aq-mode 1 --b-adapt 2 --bframes 6 --crf 0 --keyint 300 --lookahead-threads 4 --min-keyint 20 --qp 30 --qpstep 5 --qpmin 0 --qpmax 62 --rc-lookahead 18 --ref 2 --vbv-bufsize 1000 --deblock -2:-2 --me dia --overscan crop --preset veryslow --scenecut 30 --tune psnr --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
