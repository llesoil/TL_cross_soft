...
{ time x265  --aud --constrained-intra --no-weightb --aq-strength 3.0 --ipratio 1.1 --pbratio 1.3 --psy-rd 0.2 --qblur 0.5 --qcomp 0.8 --vbv-init 0.6 --aq-mode 0 --b-adapt 0 --bframes 12 --crf 5 --keyint 250 --lookahead-threads 1 --min-keyint 20 --qp 50 --qpstep 5 --qpmin 3 --qpmax 62 --rc-lookahead 18 --ref 4 --vbv-bufsize 2000 --deblock -2:-2 --me umh --overscan crop --preset fast --scenecut 40 --tune ssim --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
