...
{ time x265  --weightb --aq-strength 3.0 --ipratio 1.0 --pbratio 1.2 --psy-rd 2.2 --qblur 0.4 --qcomp 0.9 --vbv-init 0.9 --aq-mode 2 --b-adapt 1 --bframes 0 --crf 15 --keyint 280 --lookahead-threads 1 --min-keyint 26 --qp 20 --qpstep 3 --qpmin 1 --qpmax 62 --rc-lookahead 18 --ref 3 --vbv-bufsize 1000 --deblock 1:1 --me hex --overscan show --preset slow --scenecut 10 --tune ssim --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
