...
{ time x265  --aud --no-asm --slow-firstpass --no-weightb --aq-strength 0.0 --ipratio 1.4 --pbratio 1.1 --psy-rd 2.0 --qblur 0.2 --qcomp 0.6 --vbv-init 0.9 --aq-mode 0 --b-adapt 1 --bframes 16 --crf 25 --keyint 220 --lookahead-threads 4 --min-keyint 22 --qp 50 --qpstep 5 --qpmin 4 --qpmax 67 --rc-lookahead 38 --ref 2 --vbv-bufsize 1000 --deblock -1:-1 --me hex --overscan show --preset fast --scenecut 0 --tune grain --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
