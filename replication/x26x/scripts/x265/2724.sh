...
{ time x265  --constrained-intra --slow-firstpass --no-weightb --aq-strength 1.5 --ipratio 1.6 --pbratio 1.1 --psy-rd 5.0 --qblur 0.3 --qcomp 0.8 --vbv-init 0.4 --aq-mode 2 --b-adapt 2 --bframes 8 --crf 20 --keyint 220 --lookahead-threads 4 --min-keyint 29 --qp 30 --qpstep 5 --qpmin 3 --qpmax 69 --rc-lookahead 18 --ref 5 --vbv-bufsize 1000 --deblock 1:1 --me dia --overscan show --preset faster --scenecut 40 --tune psnr --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
