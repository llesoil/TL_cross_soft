...
{ time x265  --constrained-intra --no-weightb --aq-strength 2.5 --ipratio 1.6 --pbratio 1.4 --psy-rd 1.6 --qblur 0.4 --qcomp 0.6 --vbv-init 0.8 --aq-mode 0 --b-adapt 2 --bframes 10 --crf 10 --keyint 250 --lookahead-threads 0 --min-keyint 21 --qp 30 --qpstep 3 --qpmin 1 --qpmax 60 --rc-lookahead 38 --ref 5 --vbv-bufsize 1000 --deblock -1:-1 --me hex --overscan show --preset slower --scenecut 40 --tune ssim --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
