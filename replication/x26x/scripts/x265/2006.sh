...
{ time x265  --intra-refresh --no-asm --weightb --aq-strength 0.0 --ipratio 1.2 --pbratio 1.4 --psy-rd 0.4 --qblur 0.4 --qcomp 0.6 --vbv-init 0.1 --aq-mode 0 --b-adapt 0 --bframes 14 --crf 10 --keyint 260 --lookahead-threads 1 --min-keyint 20 --qp 0 --qpstep 5 --qpmin 1 --qpmax 67 --rc-lookahead 48 --ref 1 --vbv-bufsize 1000 --deblock -2:-2 --me umh --overscan show --preset medium --scenecut 0 --tune ssim --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
