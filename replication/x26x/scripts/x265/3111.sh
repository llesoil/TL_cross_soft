...
{ time x265  --aud --no-asm --weightb --aq-strength 3.0 --ipratio 1.4 --pbratio 1.0 --psy-rd 3.8 --qblur 0.5 --qcomp 0.9 --vbv-init 0.0 --aq-mode 2 --b-adapt 1 --bframes 10 --crf 5 --keyint 260 --lookahead-threads 4 --min-keyint 21 --qp 30 --qpstep 5 --qpmin 4 --qpmax 60 --rc-lookahead 48 --ref 1 --vbv-bufsize 1000 --deblock -2:-2 --me dia --overscan crop --preset slow --scenecut 30 --tune grain --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
