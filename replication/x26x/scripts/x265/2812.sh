...
{ time x265  --constrained-intra --no-asm --no-weightb --aq-strength 2.0 --ipratio 1.3 --pbratio 1.0 --psy-rd 1.8 --qblur 0.3 --qcomp 0.9 --vbv-init 0.2 --aq-mode 3 --b-adapt 2 --bframes 4 --crf 10 --keyint 250 --lookahead-threads 0 --min-keyint 26 --qp 30 --qpstep 5 --qpmin 0 --qpmax 64 --rc-lookahead 18 --ref 5 --vbv-bufsize 1000 --deblock -1:-1 --me dia --overscan crop --preset placebo --scenecut 10 --tune ssim --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
