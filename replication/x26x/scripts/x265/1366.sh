...
{ time x265  --aud --constrained-intra --slow-firstpass --no-weightb --aq-strength 2.5 --ipratio 1.0 --pbratio 1.0 --psy-rd 3.0 --qblur 0.2 --qcomp 0.8 --vbv-init 0.5 --aq-mode 3 --b-adapt 1 --bframes 12 --crf 35 --keyint 200 --lookahead-threads 0 --min-keyint 27 --qp 50 --qpstep 3 --qpmin 0 --qpmax 65 --rc-lookahead 28 --ref 6 --vbv-bufsize 2000 --deblock -1:-1 --me hex --overscan crop --preset medium --scenecut 30 --tune grain --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
