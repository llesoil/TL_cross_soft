...
{ time x265  --constrained-intra --weightb --aq-strength 1.5 --ipratio 1.4 --pbratio 1.1 --psy-rd 3.8 --qblur 0.5 --qcomp 0.9 --vbv-init 0.5 --aq-mode 0 --b-adapt 1 --bframes 2 --crf 40 --keyint 280 --lookahead-threads 0 --min-keyint 28 --qp 20 --qpstep 5 --qpmin 1 --qpmax 60 --rc-lookahead 38 --ref 5 --vbv-bufsize 1000 --deblock -2:-2 --me umh --overscan crop --preset faster --scenecut 40 --tune grain --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
