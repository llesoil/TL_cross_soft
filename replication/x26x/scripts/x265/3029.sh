...
{ time x265  --aud --constrained-intra --weightb --aq-strength 1.5 --ipratio 1.4 --pbratio 1.3 --psy-rd 0.6 --qblur 0.2 --qcomp 0.9 --vbv-init 0.0 --aq-mode 2 --b-adapt 0 --bframes 6 --crf 10 --keyint 290 --lookahead-threads 4 --min-keyint 29 --qp 0 --qpstep 5 --qpmin 3 --qpmax 67 --rc-lookahead 28 --ref 2 --vbv-bufsize 2000 --deblock 1:1 --me hex --overscan show --preset medium --scenecut 40 --tune ssim --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
