...
{ time x265  --aud --constrained-intra --no-asm --slow-firstpass --no-weightb --aq-strength 1.0 --ipratio 1.2 --pbratio 1.0 --psy-rd 3.4 --qblur 0.5 --qcomp 0.8 --vbv-init 0.0 --aq-mode 1 --b-adapt 2 --bframes 10 --crf 45 --keyint 260 --lookahead-threads 1 --min-keyint 25 --qp 30 --qpstep 3 --qpmin 3 --qpmax 62 --rc-lookahead 18 --ref 2 --vbv-bufsize 1000 --deblock -2:-2 --me hex --overscan show --preset slow --scenecut 30 --tune ssim --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
