...
{ time x265  --constrained-intra --slow-firstpass --no-weightb --aq-strength 3.0 --ipratio 1.0 --pbratio 1.4 --psy-rd 5.0 --qblur 0.4 --qcomp 0.8 --vbv-init 0.5 --aq-mode 0 --b-adapt 2 --bframes 2 --crf 40 --keyint 260 --lookahead-threads 2 --min-keyint 21 --qp 30 --qpstep 3 --qpmin 4 --qpmax 68 --rc-lookahead 18 --ref 5 --vbv-bufsize 1000 --deblock -1:-1 --me umh --overscan show --preset medium --scenecut 40 --tune animation --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
