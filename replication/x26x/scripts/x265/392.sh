...
{ time x265  --aud --constrained-intra --no-asm --weightb --aq-strength 3.0 --ipratio 1.4 --pbratio 1.2 --psy-rd 1.0 --qblur 0.5 --qcomp 0.8 --vbv-init 0.2 --aq-mode 1 --b-adapt 0 --bframes 4 --crf 45 --keyint 300 --lookahead-threads 4 --min-keyint 22 --qp 50 --qpstep 4 --qpmin 1 --qpmax 64 --rc-lookahead 28 --ref 4 --vbv-bufsize 1000 --deblock 1:1 --me dia --overscan show --preset placebo --scenecut 10 --tune grain --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
