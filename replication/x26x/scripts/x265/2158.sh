...
{ time x265  --constrained-intra --weightb --aq-strength 2.0 --ipratio 1.3 --pbratio 1.1 --psy-rd 2.6 --qblur 0.3 --qcomp 0.9 --vbv-init 0.9 --aq-mode 0 --b-adapt 0 --bframes 16 --crf 5 --keyint 220 --lookahead-threads 2 --min-keyint 25 --qp 50 --qpstep 5 --qpmin 4 --qpmax 63 --rc-lookahead 48 --ref 5 --vbv-bufsize 2000 --deblock -1:-1 --me umh --overscan show --preset veryfast --scenecut 30 --tune psnr --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
