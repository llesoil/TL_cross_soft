...
{ time x265  --constrained-intra --no-weightb --aq-strength 1.0 --ipratio 1.2 --pbratio 1.4 --psy-rd 4.6 --qblur 0.6 --qcomp 0.6 --vbv-init 0.8 --aq-mode 1 --b-adapt 1 --bframes 12 --crf 45 --keyint 220 --lookahead-threads 2 --min-keyint 20 --qp 50 --qpstep 4 --qpmin 0 --qpmax 63 --rc-lookahead 28 --ref 3 --vbv-bufsize 1000 --deblock 1:1 --me umh --overscan show --preset ultrafast --scenecut 10 --tune psnr --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
