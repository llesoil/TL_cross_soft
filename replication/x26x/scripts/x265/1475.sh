...
{ time x265  --aud --no-asm --no-weightb --aq-strength 1.0 --ipratio 1.4 --pbratio 1.0 --psy-rd 3.4 --qblur 0.2 --qcomp 0.6 --vbv-init 0.0 --aq-mode 3 --b-adapt 2 --bframes 12 --crf 45 --keyint 270 --lookahead-threads 0 --min-keyint 28 --qp 50 --qpstep 4 --qpmin 0 --qpmax 62 --rc-lookahead 28 --ref 4 --vbv-bufsize 1000 --deblock -1:-1 --me hex --overscan show --preset placebo --scenecut 10 --tune ssim --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
