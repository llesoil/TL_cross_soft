...
{ time x265  --slow-firstpass --no-weightb --aq-strength 3.0 --ipratio 1.0 --pbratio 1.2 --psy-rd 5.0 --qblur 0.6 --qcomp 0.8 --vbv-init 0.2 --aq-mode 2 --b-adapt 0 --bframes 8 --crf 20 --keyint 270 --lookahead-threads 4 --min-keyint 25 --qp 30 --qpstep 3 --qpmin 4 --qpmax 64 --rc-lookahead 18 --ref 6 --vbv-bufsize 2000 --deblock 1:1 --me hex --overscan crop --preset superfast --scenecut 30 --tune grain --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
