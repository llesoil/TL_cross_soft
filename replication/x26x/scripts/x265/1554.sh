...
{ time x265  --aud --constrained-intra --no-asm --weightb --aq-strength 3.0 --ipratio 1.1 --pbratio 1.2 --psy-rd 3.6 --qblur 0.3 --qcomp 0.8 --vbv-init 0.8 --aq-mode 0 --b-adapt 0 --bframes 16 --crf 35 --keyint 250 --lookahead-threads 4 --min-keyint 23 --qp 40 --qpstep 3 --qpmin 1 --qpmax 60 --rc-lookahead 18 --ref 1 --vbv-bufsize 1000 --deblock 1:1 --me dia --overscan show --preset veryslow --scenecut 40 --tune grain --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
