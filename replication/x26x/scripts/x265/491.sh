...
{ time x265  --no-asm --slow-firstpass --no-weightb --aq-strength 0.0 --ipratio 1.1 --pbratio 1.0 --psy-rd 1.6 --qblur 0.6 --qcomp 0.6 --vbv-init 0.5 --aq-mode 2 --b-adapt 0 --bframes 14 --crf 10 --keyint 280 --lookahead-threads 4 --min-keyint 25 --qp 40 --qpstep 3 --qpmin 1 --qpmax 62 --rc-lookahead 18 --ref 2 --vbv-bufsize 2000 --deblock -1:-1 --me hex --overscan show --preset veryslow --scenecut 40 --tune grain --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
