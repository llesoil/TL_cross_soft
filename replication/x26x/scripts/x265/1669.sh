...
{ time x265  --aud --no-weightb --aq-strength 0.0 --ipratio 1.0 --pbratio 1.3 --psy-rd 4.4 --qblur 0.5 --qcomp 0.9 --vbv-init 0.0 --aq-mode 3 --b-adapt 2 --bframes 0 --crf 0 --keyint 290 --lookahead-threads 4 --min-keyint 27 --qp 40 --qpstep 4 --qpmin 1 --qpmax 66 --rc-lookahead 48 --ref 5 --vbv-bufsize 1000 --deblock -2:-2 --me umh --overscan crop --preset slower --scenecut 30 --tune ssim --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
