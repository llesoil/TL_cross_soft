...
{ time x265  --aud --no-asm --no-weightb --aq-strength 3.0 --ipratio 1.1 --pbratio 1.4 --psy-rd 1.0 --qblur 0.5 --qcomp 0.8 --vbv-init 0.0 --aq-mode 3 --b-adapt 1 --bframes 12 --crf 45 --keyint 270 --lookahead-threads 1 --min-keyint 26 --qp 50 --qpstep 5 --qpmin 1 --qpmax 61 --rc-lookahead 28 --ref 1 --vbv-bufsize 2000 --deblock -2:-2 --me dia --overscan crop --preset veryfast --scenecut 40 --tune ssim --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
