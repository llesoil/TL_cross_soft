...
{ time x265  --constrained-intra --slow-firstpass --no-weightb --aq-strength 2.0 --ipratio 1.5 --pbratio 1.2 --psy-rd 1.8 --qblur 0.2 --qcomp 0.6 --vbv-init 0.3 --aq-mode 1 --b-adapt 1 --bframes 16 --crf 45 --keyint 290 --lookahead-threads 4 --min-keyint 27 --qp 0 --qpstep 3 --qpmin 1 --qpmax 65 --rc-lookahead 38 --ref 1 --vbv-bufsize 2000 --deblock -2:-2 --me umh --overscan crop --preset slow --scenecut 10 --tune animation --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
