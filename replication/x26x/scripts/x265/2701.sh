...
{ time x265  --weightb --aq-strength 0.5 --ipratio 1.3 --pbratio 1.2 --psy-rd 2.8 --qblur 0.4 --qcomp 0.9 --vbv-init 0.4 --aq-mode 3 --b-adapt 2 --bframes 10 --crf 20 --keyint 270 --lookahead-threads 2 --min-keyint 28 --qp 50 --qpstep 5 --qpmin 2 --qpmax 68 --rc-lookahead 48 --ref 4 --vbv-bufsize 2000 --deblock -1:-1 --me dia --overscan crop --preset veryfast --scenecut 10 --tune animation --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
