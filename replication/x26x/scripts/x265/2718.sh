...
{ time x265  --aud --slow-firstpass --no-weightb --aq-strength 3.0 --ipratio 1.0 --pbratio 1.1 --psy-rd 0.2 --qblur 0.3 --qcomp 0.8 --vbv-init 0.4 --aq-mode 1 --b-adapt 2 --bframes 16 --crf 25 --keyint 260 --lookahead-threads 1 --min-keyint 30 --qp 30 --qpstep 3 --qpmin 3 --qpmax 64 --rc-lookahead 48 --ref 4 --vbv-bufsize 1000 --deblock 1:1 --me hex --overscan crop --preset ultrafast --scenecut 0 --tune ssim --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
