...
{ time x265  --no-asm --no-weightb --aq-strength 2.5 --ipratio 1.6 --pbratio 1.4 --psy-rd 3.0 --qblur 0.4 --qcomp 0.8 --vbv-init 0.1 --aq-mode 0 --b-adapt 2 --bframes 10 --crf 25 --keyint 270 --lookahead-threads 2 --min-keyint 26 --qp 20 --qpstep 5 --qpmin 1 --qpmax 65 --rc-lookahead 28 --ref 3 --vbv-bufsize 1000 --deblock 1:1 --me hex --overscan crop --preset fast --scenecut 40 --tune psnr --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
