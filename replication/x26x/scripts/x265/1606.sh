...
{ time x265  --aud --no-asm --weightb --aq-strength 0.0 --ipratio 1.5 --pbratio 1.4 --psy-rd 4.6 --qblur 0.6 --qcomp 0.8 --vbv-init 0.9 --aq-mode 0 --b-adapt 0 --bframes 12 --crf 10 --keyint 200 --lookahead-threads 2 --min-keyint 28 --qp 50 --qpstep 5 --qpmin 3 --qpmax 63 --rc-lookahead 48 --ref 1 --vbv-bufsize 2000 --deblock -2:-2 --me umh --overscan show --preset faster --scenecut 10 --tune psnr --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
