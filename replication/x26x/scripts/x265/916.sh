...
{ time x265  --aud --intra-refresh --weightb --aq-strength 1.5 --ipratio 1.4 --pbratio 1.1 --psy-rd 1.6 --qblur 0.5 --qcomp 0.8 --vbv-init 0.6 --aq-mode 0 --b-adapt 0 --bframes 4 --crf 5 --keyint 220 --lookahead-threads 2 --min-keyint 21 --qp 0 --qpstep 3 --qpmin 3 --qpmax 60 --rc-lookahead 28 --ref 1 --vbv-bufsize 2000 --deblock 1:1 --me umh --overscan show --preset ultrafast --scenecut 0 --tune psnr --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
