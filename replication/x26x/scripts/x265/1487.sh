...
{ time x265  --aud --constrained-intra --slow-firstpass --no-weightb --aq-strength 0.5 --ipratio 1.5 --pbratio 1.2 --psy-rd 0.8 --qblur 0.3 --qcomp 0.8 --vbv-init 0.2 --aq-mode 1 --b-adapt 0 --bframes 10 --crf 25 --keyint 290 --lookahead-threads 1 --min-keyint 21 --qp 30 --qpstep 5 --qpmin 0 --qpmax 60 --rc-lookahead 18 --ref 4 --vbv-bufsize 2000 --deblock 1:1 --me umh --overscan show --preset slower --scenecut 10 --tune ssim --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
