...
{ time x265  --constrained-intra --no-weightb --aq-strength 0.0 --ipratio 1.4 --pbratio 1.2 --psy-rd 3.2 --qblur 0.6 --qcomp 0.8 --vbv-init 0.8 --aq-mode 1 --b-adapt 2 --bframes 6 --crf 45 --keyint 200 --lookahead-threads 4 --min-keyint 22 --qp 10 --qpstep 4 --qpmin 1 --qpmax 60 --rc-lookahead 48 --ref 1 --vbv-bufsize 2000 --deblock -1:-1 --me dia --overscan crop --preset medium --scenecut 40 --tune grain --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
