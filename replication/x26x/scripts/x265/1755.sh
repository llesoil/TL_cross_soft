...
{ time x265  --aud --slow-firstpass --no-weightb --aq-strength 1.0 --ipratio 1.3 --pbratio 1.3 --psy-rd 2.4 --qblur 0.2 --qcomp 0.8 --vbv-init 0.8 --aq-mode 3 --b-adapt 0 --bframes 4 --crf 0 --keyint 270 --lookahead-threads 4 --min-keyint 24 --qp 50 --qpstep 3 --qpmin 4 --qpmax 62 --rc-lookahead 18 --ref 4 --vbv-bufsize 1000 --deblock 1:1 --me dia --overscan crop --preset slower --scenecut 30 --tune ssim --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
