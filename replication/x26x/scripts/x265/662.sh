...
{ time x265  --aud --constrained-intra --no-asm --no-weightb --aq-strength 0.0 --ipratio 1.0 --pbratio 1.4 --psy-rd 2.4 --qblur 0.5 --qcomp 0.6 --vbv-init 0.6 --aq-mode 2 --b-adapt 0 --bframes 8 --crf 15 --keyint 220 --lookahead-threads 4 --min-keyint 21 --qp 30 --qpstep 5 --qpmin 4 --qpmax 61 --rc-lookahead 28 --ref 6 --vbv-bufsize 1000 --deblock -1:-1 --me dia --overscan crop --preset ultrafast --scenecut 0 --tune grain --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
