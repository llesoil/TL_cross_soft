...
{ time x265  --aud --constrained-intra --intra-refresh --no-weightb --aq-strength 2.0 --ipratio 1.3 --pbratio 1.4 --psy-rd 3.4 --qblur 0.3 --qcomp 0.6 --vbv-init 0.2 --aq-mode 2 --b-adapt 0 --bframes 12 --crf 20 --keyint 300 --lookahead-threads 1 --min-keyint 20 --qp 40 --qpstep 5 --qpmin 1 --qpmax 61 --rc-lookahead 48 --ref 1 --vbv-bufsize 2000 --deblock -2:-2 --me hex --overscan show --preset fast --scenecut 0 --tune grain --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
