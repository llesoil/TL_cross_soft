...
{ time x265  --aud --weightb --aq-strength 0.0 --ipratio 1.1 --pbratio 1.3 --psy-rd 2.8 --qblur 0.3 --qcomp 0.8 --vbv-init 0.2 --aq-mode 3 --b-adapt 1 --bframes 16 --crf 5 --keyint 200 --lookahead-threads 1 --min-keyint 20 --qp 50 --qpstep 5 --qpmin 2 --qpmax 63 --rc-lookahead 18 --ref 1 --vbv-bufsize 1000 --deblock -1:-1 --me dia --overscan crop --preset medium --scenecut 30 --tune grain --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
