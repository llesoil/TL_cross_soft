...
{ time x265  --constrained-intra --weightb --aq-strength 0.0 --ipratio 1.3 --pbratio 1.0 --psy-rd 4.0 --qblur 0.5 --qcomp 0.6 --vbv-init 0.9 --aq-mode 3 --b-adapt 1 --bframes 14 --crf 25 --keyint 250 --lookahead-threads 0 --min-keyint 26 --qp 50 --qpstep 3 --qpmin 1 --qpmax 68 --rc-lookahead 18 --ref 4 --vbv-bufsize 1000 --deblock -2:-2 --me hex --overscan show --preset veryfast --scenecut 0 --tune animation --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
