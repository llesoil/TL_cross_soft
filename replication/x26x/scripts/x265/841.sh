...
{ time x265  --constrained-intra --no-weightb --aq-strength 1.0 --ipratio 1.0 --pbratio 1.3 --psy-rd 2.4 --qblur 0.6 --qcomp 0.9 --vbv-init 0.1 --aq-mode 2 --b-adapt 2 --bframes 10 --crf 40 --keyint 260 --lookahead-threads 0 --min-keyint 25 --qp 50 --qpstep 5 --qpmin 4 --qpmax 69 --rc-lookahead 28 --ref 3 --vbv-bufsize 2000 --deblock -2:-2 --me hex --overscan show --preset medium --scenecut 10 --tune animation --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
