...
{ time x265  --aud --constrained-intra --no-asm --no-weightb --aq-strength 1.0 --ipratio 1.2 --pbratio 1.3 --psy-rd 1.4 --qblur 0.2 --qcomp 0.8 --vbv-init 0.8 --aq-mode 0 --b-adapt 1 --bframes 8 --crf 5 --keyint 220 --lookahead-threads 1 --min-keyint 28 --qp 20 --qpstep 5 --qpmin 4 --qpmax 60 --rc-lookahead 48 --ref 1 --vbv-bufsize 2000 --deblock -2:-2 --me dia --overscan show --preset slower --scenecut 30 --tune psnr --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
