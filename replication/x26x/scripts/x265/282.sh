...
{ time x265  --aud --slow-firstpass --no-weightb --aq-strength 1.0 --ipratio 1.4 --pbratio 1.4 --psy-rd 3.6 --qblur 0.3 --qcomp 0.6 --vbv-init 0.9 --aq-mode 3 --b-adapt 0 --bframes 8 --crf 15 --keyint 220 --lookahead-threads 4 --min-keyint 20 --qp 30 --qpstep 5 --qpmin 1 --qpmax 69 --rc-lookahead 48 --ref 6 --vbv-bufsize 2000 --deblock -1:-1 --me hex --overscan show --preset veryslow --scenecut 30 --tune grain --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
