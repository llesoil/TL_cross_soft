...
{ time x265  --aud --no-asm --no-weightb --aq-strength 0.5 --ipratio 1.0 --pbratio 1.4 --psy-rd 3.6 --qblur 0.2 --qcomp 0.6 --vbv-init 0.8 --aq-mode 1 --b-adapt 0 --bframes 14 --crf 0 --keyint 290 --lookahead-threads 1 --min-keyint 22 --qp 30 --qpstep 3 --qpmin 1 --qpmax 62 --rc-lookahead 48 --ref 5 --vbv-bufsize 1000 --deblock -2:-2 --me dia --overscan show --preset slower --scenecut 10 --tune grain --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
