...
{ time x265  --aud --constrained-intra --no-asm --weightb --aq-strength 1.5 --ipratio 1.1 --pbratio 1.3 --psy-rd 4.8 --qblur 0.3 --qcomp 0.6 --vbv-init 0.2 --aq-mode 2 --b-adapt 1 --bframes 12 --crf 50 --keyint 220 --lookahead-threads 3 --min-keyint 24 --qp 10 --qpstep 3 --qpmin 0 --qpmax 68 --rc-lookahead 28 --ref 1 --vbv-bufsize 1000 --deblock -1:-1 --me dia --overscan show --preset veryfast --scenecut 40 --tune psnr --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
