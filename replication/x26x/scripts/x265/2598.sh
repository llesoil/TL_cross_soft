...
{ time x265  --constrained-intra --no-asm --weightb --aq-strength 3.0 --ipratio 1.0 --pbratio 1.3 --psy-rd 0.4 --qblur 0.5 --qcomp 0.6 --vbv-init 0.6 --aq-mode 2 --b-adapt 0 --bframes 4 --crf 50 --keyint 270 --lookahead-threads 1 --min-keyint 23 --qp 30 --qpstep 3 --qpmin 4 --qpmax 67 --rc-lookahead 38 --ref 5 --vbv-bufsize 1000 --deblock 1:1 --me umh --overscan crop --preset slow --scenecut 10 --tune grain --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
