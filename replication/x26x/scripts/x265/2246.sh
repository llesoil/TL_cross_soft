...
{ time x265  --constrained-intra --no-asm --no-weightb --aq-strength 1.5 --ipratio 1.0 --pbratio 1.1 --psy-rd 3.0 --qblur 0.5 --qcomp 0.9 --vbv-init 0.9 --aq-mode 3 --b-adapt 0 --bframes 14 --crf 20 --keyint 290 --lookahead-threads 1 --min-keyint 20 --qp 50 --qpstep 5 --qpmin 0 --qpmax 63 --rc-lookahead 28 --ref 6 --vbv-bufsize 2000 --deblock 1:1 --me umh --overscan show --preset ultrafast --scenecut 0 --tune psnr --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
