...
{ time x265  --aud --weightb --aq-strength 0.5 --ipratio 1.5 --pbratio 1.3 --psy-rd 1.4 --qblur 0.3 --qcomp 0.6 --vbv-init 0.8 --aq-mode 1 --b-adapt 2 --bframes 0 --crf 10 --keyint 250 --lookahead-threads 0 --min-keyint 22 --qp 20 --qpstep 5 --qpmin 1 --qpmax 60 --rc-lookahead 48 --ref 6 --vbv-bufsize 2000 --deblock -1:-1 --me hex --overscan crop --preset placebo --scenecut 40 --tune animation --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
