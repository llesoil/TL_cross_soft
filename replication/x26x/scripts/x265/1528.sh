...
{ time x265  --no-asm --weightb --aq-strength 1.0 --ipratio 1.4 --pbratio 1.2 --psy-rd 4.8 --qblur 0.5 --qcomp 0.8 --vbv-init 0.5 --aq-mode 3 --b-adapt 2 --bframes 6 --crf 50 --keyint 290 --lookahead-threads 4 --min-keyint 26 --qp 50 --qpstep 3 --qpmin 1 --qpmax 69 --rc-lookahead 48 --ref 3 --vbv-bufsize 1000 --deblock -2:-2 --me dia --overscan crop --preset superfast --scenecut 10 --tune grain --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
