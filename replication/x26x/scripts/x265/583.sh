...
{ time x265  --constrained-intra --no-weightb --aq-strength 0.5 --ipratio 1.3 --pbratio 1.3 --psy-rd 1.2 --qblur 0.2 --qcomp 0.9 --vbv-init 0.9 --aq-mode 2 --b-adapt 1 --bframes 16 --crf 5 --keyint 250 --lookahead-threads 1 --min-keyint 22 --qp 10 --qpstep 5 --qpmin 2 --qpmax 60 --rc-lookahead 48 --ref 6 --vbv-bufsize 1000 --deblock -2:-2 --me dia --overscan crop --preset veryslow --scenecut 40 --tune animation --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
