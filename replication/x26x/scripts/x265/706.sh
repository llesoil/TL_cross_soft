...
{ time x265  --aud --no-asm --slow-firstpass --no-weightb --aq-strength 2.5 --ipratio 1.6 --pbratio 1.3 --psy-rd 0.6 --qblur 0.5 --qcomp 0.6 --vbv-init 0.5 --aq-mode 0 --b-adapt 2 --bframes 12 --crf 15 --keyint 250 --lookahead-threads 3 --min-keyint 25 --qp 30 --qpstep 4 --qpmin 1 --qpmax 63 --rc-lookahead 18 --ref 2 --vbv-bufsize 2000 --deblock 1:1 --me umh --overscan crop --preset veryfast --scenecut 30 --tune psnr --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
