...
{ time x265  --constrained-intra --no-asm --no-weightb --aq-strength 1.5 --ipratio 1.6 --pbratio 1.1 --psy-rd 1.0 --qblur 0.5 --qcomp 0.8 --vbv-init 0.0 --aq-mode 0 --b-adapt 0 --bframes 6 --crf 50 --keyint 290 --lookahead-threads 1 --min-keyint 30 --qp 20 --qpstep 5 --qpmin 1 --qpmax 65 --rc-lookahead 28 --ref 3 --vbv-bufsize 2000 --deblock 1:1 --me umh --overscan crop --preset slow --scenecut 0 --tune animation --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
