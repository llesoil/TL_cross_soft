...
{ time x265  --aud --constrained-intra --no-asm --slow-firstpass --no-weightb --aq-strength 1.0 --ipratio 1.5 --pbratio 1.2 --psy-rd 3.8 --qblur 0.4 --qcomp 0.6 --vbv-init 0.9 --aq-mode 1 --b-adapt 2 --bframes 2 --crf 20 --keyint 300 --lookahead-threads 4 --min-keyint 20 --qp 20 --qpstep 4 --qpmin 1 --qpmax 61 --rc-lookahead 18 --ref 1 --vbv-bufsize 2000 --deblock 1:1 --me umh --overscan show --preset veryslow --scenecut 30 --tune ssim --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
