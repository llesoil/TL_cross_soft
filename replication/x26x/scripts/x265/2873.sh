...
{ time x265  --no-asm --no-weightb --aq-strength 2.5 --ipratio 1.2 --pbratio 1.1 --psy-rd 1.6 --qblur 0.3 --qcomp 0.9 --vbv-init 0.8 --aq-mode 3 --b-adapt 2 --bframes 4 --crf 0 --keyint 260 --lookahead-threads 0 --min-keyint 30 --qp 10 --qpstep 4 --qpmin 1 --qpmax 67 --rc-lookahead 28 --ref 3 --vbv-bufsize 1000 --deblock -1:-1 --me dia --overscan crop --preset veryfast --scenecut 0 --tune animation --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
