...
{ time x265  --constrained-intra --no-asm --slow-firstpass --no-weightb --aq-strength 1.0 --ipratio 1.1 --pbratio 1.3 --psy-rd 0.4 --qblur 0.6 --qcomp 0.6 --vbv-init 0.0 --aq-mode 2 --b-adapt 1 --bframes 16 --crf 10 --keyint 220 --lookahead-threads 4 --min-keyint 22 --qp 0 --qpstep 3 --qpmin 1 --qpmax 68 --rc-lookahead 48 --ref 1 --vbv-bufsize 2000 --deblock 1:1 --me umh --overscan show --preset veryslow --scenecut 30 --tune psnr --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
