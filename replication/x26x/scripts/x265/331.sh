...
{ time x265  --no-weightb --aq-strength 1.0 --ipratio 1.2 --pbratio 1.3 --psy-rd 2.0 --qblur 0.5 --qcomp 0.6 --vbv-init 0.0 --aq-mode 2 --b-adapt 2 --bframes 4 --crf 15 --keyint 280 --lookahead-threads 1 --min-keyint 26 --qp 30 --qpstep 4 --qpmin 1 --qpmax 68 --rc-lookahead 48 --ref 2 --vbv-bufsize 2000 --deblock -2:-2 --me hex --overscan show --preset slow --scenecut 40 --tune grain --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
