...
{ time x265  --aud --constrained-intra --slow-firstpass --no-weightb --aq-strength 0.0 --ipratio 1.6 --pbratio 1.2 --psy-rd 3.8 --qblur 0.4 --qcomp 0.8 --vbv-init 0.6 --aq-mode 2 --b-adapt 1 --bframes 4 --crf 20 --keyint 200 --lookahead-threads 2 --min-keyint 29 --qp 20 --qpstep 4 --qpmin 1 --qpmax 65 --rc-lookahead 48 --ref 3 --vbv-bufsize 1000 --deblock 1:1 --me dia --overscan show --preset veryfast --scenecut 30 --tune ssim --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
