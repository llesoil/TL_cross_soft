...
{ time x265  --aud --constrained-intra --no-asm --no-weightb --aq-strength 1.0 --ipratio 1.1 --pbratio 1.1 --psy-rd 0.4 --qblur 0.5 --qcomp 0.9 --vbv-init 0.8 --aq-mode 1 --b-adapt 2 --bframes 14 --crf 35 --keyint 290 --lookahead-threads 4 --min-keyint 26 --qp 10 --qpstep 4 --qpmin 1 --qpmax 64 --rc-lookahead 28 --ref 4 --vbv-bufsize 1000 --deblock 1:1 --me hex --overscan crop --preset veryfast --scenecut 10 --tune psnr --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
