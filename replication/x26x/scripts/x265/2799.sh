...
{ time x265  --aud --no-asm --no-weightb --aq-strength 0.5 --ipratio 1.6 --pbratio 1.1 --psy-rd 2.4 --qblur 0.6 --qcomp 0.9 --vbv-init 0.0 --aq-mode 3 --b-adapt 2 --bframes 8 --crf 40 --keyint 290 --lookahead-threads 4 --min-keyint 24 --qp 30 --qpstep 4 --qpmin 4 --qpmax 65 --rc-lookahead 18 --ref 2 --vbv-bufsize 2000 --deblock -1:-1 --me umh --overscan show --preset veryfast --scenecut 30 --tune ssim --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
