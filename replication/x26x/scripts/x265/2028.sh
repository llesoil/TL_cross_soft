...
{ time x265  --aud --constrained-intra --no-weightb --aq-strength 1.5 --ipratio 1.4 --pbratio 1.0 --psy-rd 3.6 --qblur 0.3 --qcomp 0.6 --vbv-init 0.1 --aq-mode 0 --b-adapt 0 --bframes 10 --crf 10 --keyint 200 --lookahead-threads 1 --min-keyint 24 --qp 10 --qpstep 5 --qpmin 3 --qpmax 66 --rc-lookahead 38 --ref 2 --vbv-bufsize 2000 --deblock -2:-2 --me dia --overscan crop --preset veryfast --scenecut 0 --tune psnr --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
