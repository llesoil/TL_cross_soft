...
{ time x265  --aud --no-asm --weightb --aq-strength 3.0 --ipratio 1.0 --pbratio 1.3 --psy-rd 4.2 --qblur 0.6 --qcomp 0.9 --vbv-init 0.5 --aq-mode 0 --b-adapt 2 --bframes 16 --crf 0 --keyint 280 --lookahead-threads 0 --min-keyint 30 --qp 50 --qpstep 3 --qpmin 3 --qpmax 66 --rc-lookahead 38 --ref 1 --vbv-bufsize 2000 --deblock -1:-1 --me dia --overscan show --preset slower --scenecut 0 --tune grain --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
