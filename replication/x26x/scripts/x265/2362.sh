...
{ time x265  --no-weightb --aq-strength 1.5 --ipratio 1.0 --pbratio 1.3 --psy-rd 2.6 --qblur 0.5 --qcomp 0.6 --vbv-init 0.4 --aq-mode 0 --b-adapt 1 --bframes 14 --crf 0 --keyint 200 --lookahead-threads 2 --min-keyint 20 --qp 50 --qpstep 5 --qpmin 1 --qpmax 69 --rc-lookahead 18 --ref 3 --vbv-bufsize 2000 --deblock -1:-1 --me dia --overscan show --preset fast --scenecut 40 --tune animation --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
