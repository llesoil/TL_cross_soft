...
{ time x265  --aud --no-weightb --aq-strength 3.0 --ipratio 1.6 --pbratio 1.4 --psy-rd 4.4 --qblur 0.3 --qcomp 0.9 --vbv-init 0.2 --aq-mode 2 --b-adapt 1 --bframes 4 --crf 5 --keyint 270 --lookahead-threads 0 --min-keyint 25 --qp 0 --qpstep 4 --qpmin 1 --qpmax 67 --rc-lookahead 18 --ref 2 --vbv-bufsize 2000 --deblock -1:-1 --me hex --overscan show --preset placebo --scenecut 0 --tune grain --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
