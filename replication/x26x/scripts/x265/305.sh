...
{ time x265  --aud --no-weightb --aq-strength 1.5 --ipratio 1.6 --pbratio 1.1 --psy-rd 5.0 --qblur 0.3 --qcomp 0.8 --vbv-init 0.6 --aq-mode 2 --b-adapt 1 --bframes 10 --crf 5 --keyint 200 --lookahead-threads 4 --min-keyint 25 --qp 20 --qpstep 4 --qpmin 1 --qpmax 67 --rc-lookahead 18 --ref 2 --vbv-bufsize 2000 --deblock -2:-2 --me dia --overscan crop --preset medium --scenecut 10 --tune animation --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
