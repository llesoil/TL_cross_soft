...
{ time x265  --no-weightb --aq-strength 2.0 --ipratio 1.1 --pbratio 1.0 --psy-rd 3.0 --qblur 0.4 --qcomp 0.8 --vbv-init 0.2 --aq-mode 0 --b-adapt 0 --bframes 6 --crf 5 --keyint 250 --lookahead-threads 2 --min-keyint 24 --qp 30 --qpstep 5 --qpmin 4 --qpmax 62 --rc-lookahead 38 --ref 2 --vbv-bufsize 1000 --deblock -1:-1 --me umh --overscan show --preset medium --scenecut 40 --tune grain --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
