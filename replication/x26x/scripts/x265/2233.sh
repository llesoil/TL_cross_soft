...
{ time x265  --aud --no-asm --slow-firstpass --no-weightb --aq-strength 2.5 --ipratio 1.5 --pbratio 1.4 --psy-rd 0.8 --qblur 0.6 --qcomp 0.6 --vbv-init 0.2 --aq-mode 0 --b-adapt 0 --bframes 10 --crf 50 --keyint 300 --lookahead-threads 4 --min-keyint 29 --qp 30 --qpstep 4 --qpmin 1 --qpmax 69 --rc-lookahead 38 --ref 4 --vbv-bufsize 2000 --deblock -2:-2 --me hex --overscan show --preset slow --scenecut 40 --tune animation --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
