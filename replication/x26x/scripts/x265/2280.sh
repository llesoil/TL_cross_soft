...
{ time x265  --aud --constrained-intra --no-asm --weightb --aq-strength 1.0 --ipratio 1.1 --pbratio 1.4 --psy-rd 4.4 --qblur 0.5 --qcomp 0.8 --vbv-init 0.3 --aq-mode 2 --b-adapt 2 --bframes 0 --crf 15 --keyint 260 --lookahead-threads 2 --min-keyint 29 --qp 30 --qpstep 5 --qpmin 1 --qpmax 61 --rc-lookahead 38 --ref 4 --vbv-bufsize 2000 --deblock 1:1 --me dia --overscan show --preset medium --scenecut 30 --tune psnr --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
