...
{ time x265  --constrained-intra --weightb --aq-strength 0.5 --ipratio 1.2 --pbratio 1.0 --psy-rd 2.2 --qblur 0.5 --qcomp 0.6 --vbv-init 0.3 --aq-mode 2 --b-adapt 2 --bframes 10 --crf 5 --keyint 220 --lookahead-threads 0 --min-keyint 25 --qp 20 --qpstep 4 --qpmin 1 --qpmax 66 --rc-lookahead 18 --ref 3 --vbv-bufsize 1000 --deblock -1:-1 --me hex --overscan show --preset superfast --scenecut 40 --tune psnr --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
