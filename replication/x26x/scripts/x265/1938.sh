...
{ time x265  --aud --slow-firstpass --no-weightb --aq-strength 2.0 --ipratio 1.2 --pbratio 1.0 --psy-rd 3.2 --qblur 0.4 --qcomp 0.9 --vbv-init 0.9 --aq-mode 3 --b-adapt 0 --bframes 4 --crf 20 --keyint 220 --lookahead-threads 1 --min-keyint 28 --qp 30 --qpstep 4 --qpmin 3 --qpmax 64 --rc-lookahead 18 --ref 5 --vbv-bufsize 2000 --deblock 1:1 --me umh --overscan show --preset ultrafast --scenecut 40 --tune animation --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
