...
{ time x265  --no-asm --weightb --aq-strength 1.0 --ipratio 1.4 --pbratio 1.3 --psy-rd 1.6 --qblur 0.3 --qcomp 0.6 --vbv-init 0.0 --aq-mode 1 --b-adapt 2 --bframes 2 --crf 5 --keyint 260 --lookahead-threads 0 --min-keyint 26 --qp 50 --qpstep 3 --qpmin 1 --qpmax 61 --rc-lookahead 48 --ref 1 --vbv-bufsize 1000 --deblock -2:-2 --me hex --overscan show --preset fast --scenecut 40 --tune ssim --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
