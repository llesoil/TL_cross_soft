...
{ time x265  --constrained-intra --weightb --aq-strength 2.0 --ipratio 1.3 --pbratio 1.1 --psy-rd 4.2 --qblur 0.6 --qcomp 0.8 --vbv-init 0.4 --aq-mode 0 --b-adapt 0 --bframes 14 --crf 45 --keyint 270 --lookahead-threads 4 --min-keyint 27 --qp 40 --qpstep 4 --qpmin 1 --qpmax 61 --rc-lookahead 48 --ref 1 --vbv-bufsize 1000 --deblock -2:-2 --me dia --overscan show --preset slow --scenecut 40 --tune psnr --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
