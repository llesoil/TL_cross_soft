...
{ time x265  --constrained-intra --no-weightb --aq-strength 3.0 --ipratio 1.4 --pbratio 1.4 --psy-rd 2.0 --qblur 0.6 --qcomp 0.6 --vbv-init 0.2 --aq-mode 1 --b-adapt 1 --bframes 14 --crf 5 --keyint 200 --lookahead-threads 2 --min-keyint 22 --qp 30 --qpstep 3 --qpmin 0 --qpmax 63 --rc-lookahead 18 --ref 2 --vbv-bufsize 2000 --deblock -2:-2 --me dia --overscan show --preset placebo --scenecut 30 --tune psnr --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
