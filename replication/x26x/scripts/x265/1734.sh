...
{ time x265  --slow-firstpass --no-weightb --aq-strength 1.5 --ipratio 1.1 --pbratio 1.2 --psy-rd 1.0 --qblur 0.4 --qcomp 0.6 --vbv-init 0.1 --aq-mode 2 --b-adapt 0 --bframes 0 --crf 40 --keyint 290 --lookahead-threads 0 --min-keyint 22 --qp 10 --qpstep 5 --qpmin 4 --qpmax 60 --rc-lookahead 18 --ref 1 --vbv-bufsize 2000 --deblock 1:1 --me dia --overscan show --preset slow --scenecut 40 --tune psnr --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
