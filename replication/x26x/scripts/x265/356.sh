...
{ time x265  --aud --constrained-intra --weightb --aq-strength 0.5 --ipratio 1.5 --pbratio 1.1 --psy-rd 3.2 --qblur 0.5 --qcomp 0.9 --vbv-init 0.4 --aq-mode 1 --b-adapt 1 --bframes 14 --crf 20 --keyint 290 --lookahead-threads 1 --min-keyint 22 --qp 40 --qpstep 4 --qpmin 1 --qpmax 66 --rc-lookahead 18 --ref 4 --vbv-bufsize 2000 --deblock -2:-2 --me umh --overscan show --preset faster --scenecut 0 --tune animation --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
