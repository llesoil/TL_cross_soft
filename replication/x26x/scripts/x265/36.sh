...
{ time x265  --aud --constrained-intra --slow-firstpass --no-weightb --aq-strength 2.0 --ipratio 1.4 --pbratio 1.2 --psy-rd 5.0 --qblur 0.3 --qcomp 0.6 --vbv-init 0.1 --aq-mode 1 --b-adapt 2 --bframes 14 --crf 40 --keyint 290 --lookahead-threads 3 --min-keyint 29 --qp 50 --qpstep 4 --qpmin 3 --qpmax 62 --rc-lookahead 38 --ref 1 --vbv-bufsize 1000 --deblock 1:1 --me umh --overscan show --preset veryslow --scenecut 40 --tune grain --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
