...
{ time x265  --weightb --aq-strength 1.5 --ipratio 1.0 --pbratio 1.1 --psy-rd 3.0 --qblur 0.2 --qcomp 0.8 --vbv-init 0.3 --aq-mode 3 --b-adapt 2 --bframes 0 --crf 20 --keyint 260 --lookahead-threads 2 --min-keyint 20 --qp 10 --qpstep 3 --qpmin 1 --qpmax 61 --rc-lookahead 38 --ref 2 --vbv-bufsize 2000 --deblock -1:-1 --me dia --overscan show --preset veryslow --scenecut 30 --tune grain --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
