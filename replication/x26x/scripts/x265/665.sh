...
{ time x265  --aud --constrained-intra --weightb --aq-strength 2.0 --ipratio 1.2 --pbratio 1.3 --psy-rd 0.2 --qblur 0.3 --qcomp 0.9 --vbv-init 0.2 --aq-mode 1 --b-adapt 0 --bframes 14 --crf 45 --keyint 280 --lookahead-threads 0 --min-keyint 22 --qp 30 --qpstep 5 --qpmin 2 --qpmax 65 --rc-lookahead 48 --ref 1 --vbv-bufsize 1000 --deblock -1:-1 --me umh --overscan show --preset medium --scenecut 30 --tune grain --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
