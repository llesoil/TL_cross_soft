...
{ time x265  --constrained-intra --weightb --aq-strength 2.0 --ipratio 1.6 --pbratio 1.2 --psy-rd 4.8 --qblur 0.5 --qcomp 0.6 --vbv-init 0.1 --aq-mode 2 --b-adapt 1 --bframes 4 --crf 5 --keyint 220 --lookahead-threads 4 --min-keyint 22 --qp 30 --qpstep 5 --qpmin 0 --qpmax 69 --rc-lookahead 38 --ref 1 --vbv-bufsize 2000 --deblock -1:-1 --me umh --overscan show --preset fast --scenecut 40 --tune grain --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
