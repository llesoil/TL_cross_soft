...
{ time x265  --constrained-intra --weightb --aq-strength 3.0 --ipratio 1.4 --pbratio 1.4 --psy-rd 0.8 --qblur 0.4 --qcomp 0.6 --vbv-init 0.9 --aq-mode 2 --b-adapt 1 --bframes 14 --crf 0 --keyint 290 --lookahead-threads 2 --min-keyint 23 --qp 0 --qpstep 3 --qpmin 2 --qpmax 60 --rc-lookahead 28 --ref 1 --vbv-bufsize 1000 --deblock -2:-2 --me umh --overscan show --preset slower --scenecut 40 --tune ssim --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
