...
{ time x265  --weightb --aq-strength 1.0 --ipratio 1.4 --pbratio 1.1 --psy-rd 0.4 --qblur 0.5 --qcomp 0.8 --vbv-init 0.6 --aq-mode 0 --b-adapt 1 --bframes 6 --crf 25 --keyint 200 --lookahead-threads 1 --min-keyint 27 --qp 20 --qpstep 3 --qpmin 1 --qpmax 69 --rc-lookahead 18 --ref 2 --vbv-bufsize 1000 --deblock 1:1 --me dia --overscan crop --preset slow --scenecut 10 --tune grain --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
