...
{ time x265  --constrained-intra --weightb --aq-strength 2.0 --ipratio 1.4 --pbratio 1.1 --psy-rd 2.2 --qblur 0.4 --qcomp 0.8 --vbv-init 0.1 --aq-mode 3 --b-adapt 2 --bframes 6 --crf 20 --keyint 270 --lookahead-threads 2 --min-keyint 28 --qp 40 --qpstep 5 --qpmin 1 --qpmax 63 --rc-lookahead 28 --ref 1 --vbv-bufsize 1000 --deblock 1:1 --me umh --overscan show --preset ultrafast --scenecut 0 --tune psnr --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
