...
{ time x265  --constrained-intra --no-asm --weightb --aq-strength 0.5 --ipratio 1.2 --pbratio 1.1 --psy-rd 4.2 --qblur 0.4 --qcomp 0.8 --vbv-init 0.3 --aq-mode 2 --b-adapt 0 --bframes 12 --crf 0 --keyint 270 --lookahead-threads 0 --min-keyint 21 --qp 30 --qpstep 5 --qpmin 3 --qpmax 67 --rc-lookahead 38 --ref 5 --vbv-bufsize 1000 --deblock -2:-2 --me hex --overscan show --preset veryslow --scenecut 30 --tune psnr --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
