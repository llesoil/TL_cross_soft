...
{ time x265  --aud --constrained-intra --slow-firstpass --no-weightb --aq-strength 3.0 --ipratio 1.5 --pbratio 1.3 --psy-rd 0.8 --qblur 0.6 --qcomp 0.8 --vbv-init 0.6 --aq-mode 1 --b-adapt 2 --bframes 10 --crf 20 --keyint 290 --lookahead-threads 0 --min-keyint 29 --qp 10 --qpstep 4 --qpmin 3 --qpmax 65 --rc-lookahead 38 --ref 1 --vbv-bufsize 1000 --deblock -2:-2 --me hex --overscan show --preset faster --scenecut 10 --tune psnr --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
