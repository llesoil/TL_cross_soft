...
{ time x265  --aud --constrained-intra --slow-firstpass --no-weightb --aq-strength 1.0 --ipratio 1.2 --pbratio 1.2 --psy-rd 4.2 --qblur 0.6 --qcomp 0.8 --vbv-init 0.1 --aq-mode 3 --b-adapt 0 --bframes 2 --crf 35 --keyint 250 --lookahead-threads 4 --min-keyint 28 --qp 30 --qpstep 3 --qpmin 4 --qpmax 60 --rc-lookahead 38 --ref 4 --vbv-bufsize 1000 --deblock 1:1 --me umh --overscan show --preset veryfast --scenecut 30 --tune psnr --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
