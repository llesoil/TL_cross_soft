...
{ time x265  --aud --constrained-intra --weightb --aq-strength 0.5 --ipratio 1.6 --pbratio 1.4 --psy-rd 4.6 --qblur 0.4 --qcomp 0.8 --vbv-init 0.1 --aq-mode 3 --b-adapt 1 --bframes 4 --crf 0 --keyint 290 --lookahead-threads 1 --min-keyint 20 --qp 10 --qpstep 3 --qpmin 1 --qpmax 66 --rc-lookahead 38 --ref 5 --vbv-bufsize 1000 --deblock 1:1 --me hex --overscan crop --preset veryfast --scenecut 30 --tune ssim --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
