...
{ time x265  --aud --no-weightb --aq-strength 3.0 --ipratio 1.5 --pbratio 1.0 --psy-rd 3.4 --qblur 0.3 --qcomp 0.9 --vbv-init 0.9 --aq-mode 2 --b-adapt 0 --bframes 16 --crf 40 --keyint 290 --lookahead-threads 1 --min-keyint 26 --qp 50 --qpstep 4 --qpmin 3 --qpmax 68 --rc-lookahead 28 --ref 2 --vbv-bufsize 1000 --deblock -1:-1 --me hex --overscan crop --preset placebo --scenecut 0 --tune grain --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
