...
{ time x265  --aud --weightb --aq-strength 0.5 --ipratio 1.5 --pbratio 1.0 --psy-rd 0.6 --qblur 0.4 --qcomp 0.6 --vbv-init 0.1 --aq-mode 2 --b-adapt 0 --bframes 16 --crf 35 --keyint 300 --lookahead-threads 2 --min-keyint 23 --qp 0 --qpstep 5 --qpmin 1 --qpmax 61 --rc-lookahead 18 --ref 3 --vbv-bufsize 1000 --deblock 1:1 --me umh --overscan show --preset ultrafast --scenecut 10 --tune ssim --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
