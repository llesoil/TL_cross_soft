...
{ time x265  --aud --constrained-intra --slow-firstpass --no-weightb --aq-strength 1.0 --ipratio 1.2 --pbratio 1.4 --psy-rd 1.4 --qblur 0.6 --qcomp 0.9 --vbv-init 0.3 --aq-mode 3 --b-adapt 0 --bframes 10 --crf 5 --keyint 290 --lookahead-threads 4 --min-keyint 23 --qp 0 --qpstep 3 --qpmin 1 --qpmax 63 --rc-lookahead 48 --ref 3 --vbv-bufsize 1000 --deblock -1:-1 --me dia --overscan show --preset ultrafast --scenecut 0 --tune psnr --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
