...
{ time x265  --aud --no-weightb --aq-strength 0.5 --ipratio 1.1 --pbratio 1.1 --psy-rd 0.8 --qblur 0.4 --qcomp 0.8 --vbv-init 0.8 --aq-mode 3 --b-adapt 2 --bframes 8 --crf 15 --keyint 290 --lookahead-threads 2 --min-keyint 23 --qp 30 --qpstep 4 --qpmin 2 --qpmax 67 --rc-lookahead 28 --ref 3 --vbv-bufsize 1000 --deblock -1:-1 --me dia --overscan show --preset veryfast --scenecut 0 --tune animation --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
