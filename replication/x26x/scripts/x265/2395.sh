...
{ time x265  --aud --constrained-intra --no-weightb --aq-strength 1.5 --ipratio 1.6 --pbratio 1.2 --psy-rd 4.2 --qblur 0.2 --qcomp 0.6 --vbv-init 0.4 --aq-mode 3 --b-adapt 1 --bframes 14 --crf 5 --keyint 270 --lookahead-threads 4 --min-keyint 20 --qp 50 --qpstep 4 --qpmin 2 --qpmax 65 --rc-lookahead 48 --ref 2 --vbv-bufsize 2000 --deblock -2:-2 --me dia --overscan crop --preset ultrafast --scenecut 40 --tune grain --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
