...
{ time x265  --constrained-intra --no-asm --weightb --aq-strength 0.5 --ipratio 1.5 --pbratio 1.3 --psy-rd 3.8 --qblur 0.4 --qcomp 0.6 --vbv-init 0.4 --aq-mode 0 --b-adapt 2 --bframes 6 --crf 5 --keyint 250 --lookahead-threads 0 --min-keyint 22 --qp 10 --qpstep 4 --qpmin 1 --qpmax 66 --rc-lookahead 28 --ref 5 --vbv-bufsize 1000 --deblock -1:-1 --me hex --overscan crop --preset slower --scenecut 10 --tune grain --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
