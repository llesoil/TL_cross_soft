...
{ time x265  --aud --no-asm --slow-firstpass --no-weightb --aq-strength 3.0 --ipratio 1.4 --pbratio 1.2 --psy-rd 1.0 --qblur 0.5 --qcomp 0.8 --vbv-init 0.8 --aq-mode 2 --b-adapt 1 --bframes 4 --crf 5 --keyint 270 --lookahead-threads 1 --min-keyint 29 --qp 40 --qpstep 5 --qpmin 3 --qpmax 68 --rc-lookahead 18 --ref 3 --vbv-bufsize 1000 --deblock -2:-2 --me umh --overscan crop --preset placebo --scenecut 30 --tune ssim --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
