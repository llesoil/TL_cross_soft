...
{ time x265  --slow-firstpass --no-weightb --aq-strength 0.5 --ipratio 1.5 --pbratio 1.2 --psy-rd 3.4 --qblur 0.5 --qcomp 0.6 --vbv-init 0.8 --aq-mode 2 --b-adapt 2 --bframes 0 --crf 20 --keyint 290 --lookahead-threads 2 --min-keyint 21 --qp 10 --qpstep 4 --qpmin 1 --qpmax 60 --rc-lookahead 18 --ref 2 --vbv-bufsize 2000 --deblock 1:1 --me hex --overscan crop --preset slow --scenecut 0 --tune animation --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
