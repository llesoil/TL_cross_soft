...
{ time x265  --constrained-intra --weightb --aq-strength 1.5 --ipratio 1.2 --pbratio 1.2 --psy-rd 2.0 --qblur 0.5 --qcomp 0.9 --vbv-init 0.4 --aq-mode 0 --b-adapt 2 --bframes 10 --crf 15 --keyint 300 --lookahead-threads 0 --min-keyint 30 --qp 0 --qpstep 5 --qpmin 1 --qpmax 61 --rc-lookahead 48 --ref 3 --vbv-bufsize 2000 --deblock -2:-2 --me hex --overscan crop --preset medium --scenecut 30 --tune animation --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
