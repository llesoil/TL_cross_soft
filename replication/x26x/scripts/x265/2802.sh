...
{ time x265  --aud --no-asm --weightb --aq-strength 1.0 --ipratio 1.3 --pbratio 1.1 --psy-rd 2.8 --qblur 0.5 --qcomp 0.9 --vbv-init 0.9 --aq-mode 0 --b-adapt 2 --bframes 6 --crf 40 --keyint 250 --lookahead-threads 1 --min-keyint 24 --qp 30 --qpstep 4 --qpmin 3 --qpmax 64 --rc-lookahead 38 --ref 3 --vbv-bufsize 1000 --deblock -1:-1 --me dia --overscan crop --preset veryslow --scenecut 30 --tune grain --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
