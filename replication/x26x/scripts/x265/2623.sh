...
{ time x265  --constrained-intra --no-asm --no-weightb --aq-strength 0.0 --ipratio 1.3 --pbratio 1.0 --psy-rd 2.0 --qblur 0.2 --qcomp 0.9 --vbv-init 0.9 --aq-mode 0 --b-adapt 2 --bframes 14 --crf 15 --keyint 300 --lookahead-threads 2 --min-keyint 28 --qp 40 --qpstep 4 --qpmin 1 --qpmax 62 --rc-lookahead 18 --ref 6 --vbv-bufsize 2000 --deblock 1:1 --me hex --overscan crop --preset ultrafast --scenecut 0 --tune ssim --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
