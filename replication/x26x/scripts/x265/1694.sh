...
{ time x265  --aud --constrained-intra --no-asm --weightb --aq-strength 0.0 --ipratio 1.2 --pbratio 1.2 --psy-rd 3.6 --qblur 0.4 --qcomp 0.8 --vbv-init 0.5 --aq-mode 3 --b-adapt 0 --bframes 14 --crf 15 --keyint 300 --lookahead-threads 4 --min-keyint 27 --qp 30 --qpstep 3 --qpmin 1 --qpmax 68 --rc-lookahead 28 --ref 6 --vbv-bufsize 1000 --deblock 1:1 --me dia --overscan crop --preset placebo --scenecut 40 --tune psnr --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
