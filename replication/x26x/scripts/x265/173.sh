...
{ time x265  --no-asm --no-weightb --aq-strength 0.5 --ipratio 1.6 --pbratio 1.3 --psy-rd 3.6 --qblur 0.4 --qcomp 0.8 --vbv-init 0.6 --aq-mode 0 --b-adapt 0 --bframes 2 --crf 25 --keyint 280 --lookahead-threads 4 --min-keyint 24 --qp 30 --qpstep 4 --qpmin 1 --qpmax 66 --rc-lookahead 18 --ref 3 --vbv-bufsize 1000 --deblock -1:-1 --me umh --overscan show --preset veryfast --scenecut 10 --tune grain --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
