...
{ time x265  --aud --weightb --aq-strength 0.5 --ipratio 1.1 --pbratio 1.2 --psy-rd 0.4 --qblur 0.4 --qcomp 0.8 --vbv-init 0.8 --aq-mode 1 --b-adapt 0 --bframes 14 --crf 0 --keyint 300 --lookahead-threads 2 --min-keyint 28 --qp 50 --qpstep 4 --qpmin 3 --qpmax 67 --rc-lookahead 48 --ref 1 --vbv-bufsize 1000 --deblock -2:-2 --me umh --overscan show --preset veryfast --scenecut 40 --tune psnr --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
