...
{ time x265  --aud --constrained-intra --no-asm --weightb --aq-strength 0.0 --ipratio 1.6 --pbratio 1.1 --psy-rd 4.0 --qblur 0.5 --qcomp 0.9 --vbv-init 0.1 --aq-mode 3 --b-adapt 1 --bframes 8 --crf 20 --keyint 250 --lookahead-threads 4 --min-keyint 22 --qp 30 --qpstep 4 --qpmin 3 --qpmax 68 --rc-lookahead 38 --ref 6 --vbv-bufsize 2000 --deblock 1:1 --me hex --overscan show --preset faster --scenecut 10 --tune psnr --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
