...
{ time x265  --weightb --aq-strength 0.0 --ipratio 1.6 --pbratio 1.3 --psy-rd 1.2 --qblur 0.3 --qcomp 0.9 --vbv-init 0.9 --aq-mode 3 --b-adapt 0 --bframes 6 --crf 0 --keyint 290 --lookahead-threads 2 --min-keyint 23 --qp 20 --qpstep 4 --qpmin 1 --qpmax 61 --rc-lookahead 18 --ref 3 --vbv-bufsize 2000 --deblock 1:1 --me dia --overscan show --preset veryfast --scenecut 40 --tune grain --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
