...
{ time x265  --constrained-intra --intra-refresh --no-asm --no-weightb --aq-strength 1.0 --ipratio 1.0 --pbratio 1.3 --psy-rd 4.4 --qblur 0.4 --qcomp 0.8 --vbv-init 0.5 --aq-mode 0 --b-adapt 2 --bframes 4 --crf 15 --keyint 270 --lookahead-threads 0 --min-keyint 24 --qp 40 --qpstep 3 --qpmin 2 --qpmax 62 --rc-lookahead 38 --ref 1 --vbv-bufsize 1000 --deblock 1:1 --me dia --overscan show --preset veryfast --scenecut 0 --tune psnr --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
