...
{ time x264  --constrained-intra --no-asm --weightb --aq-strength 1.0 --ipratio 1.2 --pbratio 1.2 --psy-rd 2.8 --qblur 0.5 --qcomp 0.8 --vbv-init 0.6 --aq-mode 1 --b-adapt 0 --bframes 4 --crf 5 --keyint 250 --lookahead-threads 2 --min-keyint 29 --qp 20 --qpstep 3 --qpmin 0 --qpmax 64 --rc-lookahead 28 --ref 5 --vbv-bufsize 1000 --deblock -1:-1 --me umh --overscan crop --preset placebo --scenecut 30 --tune ssim --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
