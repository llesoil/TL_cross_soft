...
{ time x264  --no-asm --weightb --aq-strength 2.0 --ipratio 1.0 --pbratio 1.1 --psy-rd 1.4 --qblur 0.4 --qcomp 0.8 --vbv-init 0.2 --aq-mode 3 --b-adapt 0 --bframes 0 --crf 0 --keyint 270 --lookahead-threads 4 --min-keyint 23 --qp 50 --qpstep 3 --qpmin 2 --qpmax 67 --rc-lookahead 18 --ref 1 --vbv-bufsize 2000 --deblock -2:-2 --me hex --overscan show --preset ultrafast --scenecut 40 --tune ssim --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
