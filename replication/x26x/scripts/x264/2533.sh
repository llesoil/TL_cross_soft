...
{ time x264  --aud --slow-firstpass --no-weightb --aq-strength 3.0 --ipratio 1.0 --pbratio 1.0 --psy-rd 0.4 --qblur 0.6 --qcomp 0.9 --vbv-init 0.3 --aq-mode 3 --b-adapt 2 --bframes 0 --crf 5 --keyint 270 --lookahead-threads 4 --min-keyint 29 --qp 40 --qpstep 3 --qpmin 3 --qpmax 66 --rc-lookahead 18 --ref 5 --vbv-bufsize 2000 --deblock 1:1 --me umh --overscan crop --preset fast --scenecut 30 --tune ssim --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
