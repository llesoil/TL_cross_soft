...
{ time x264  --aud --constrained-intra --no-asm --weightb --aq-strength 1.5 --ipratio 1.2 --pbratio 1.4 --psy-rd 5.0 --qblur 0.6 --qcomp 0.6 --vbv-init 0.2 --aq-mode 2 --b-adapt 2 --bframes 14 --crf 0 --keyint 280 --lookahead-threads 2 --min-keyint 25 --qp 40 --qpstep 3 --qpmin 1 --qpmax 61 --rc-lookahead 38 --ref 3 --vbv-bufsize 2000 --deblock -1:-1 --me hex --overscan crop --preset slower --scenecut 10 --tune grain --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
