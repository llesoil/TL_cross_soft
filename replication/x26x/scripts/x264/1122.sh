...
{ time x264  --no-asm --no-weightb --aq-strength 1.5 --ipratio 1.2 --pbratio 1.3 --psy-rd 1.8 --qblur 0.3 --qcomp 0.8 --vbv-init 0.9 --aq-mode 1 --b-adapt 0 --bframes 8 --crf 15 --keyint 270 --lookahead-threads 4 --min-keyint 26 --qp 20 --qpstep 4 --qpmin 4 --qpmax 60 --rc-lookahead 18 --ref 2 --vbv-bufsize 1000 --deblock -2:-2 --me hex --overscan crop --preset fast --scenecut 30 --tune psnr --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
