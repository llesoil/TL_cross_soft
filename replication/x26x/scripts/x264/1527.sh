...
{ time x264  --aud --no-weightb --aq-strength 2.0 --ipratio 1.5 --pbratio 1.1 --psy-rd 1.0 --qblur 0.5 --qcomp 0.9 --vbv-init 0.1 --aq-mode 3 --b-adapt 1 --bframes 8 --crf 5 --keyint 300 --lookahead-threads 1 --min-keyint 30 --qp 50 --qpstep 5 --qpmin 2 --qpmax 63 --rc-lookahead 38 --ref 3 --vbv-bufsize 1000 --deblock -1:-1 --me hex --overscan show --preset slower --scenecut 10 --tune psnr --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
