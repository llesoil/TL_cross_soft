...
{ time x264  --constrained-intra --no-asm --no-weightb --aq-strength 1.0 --ipratio 1.5 --pbratio 1.4 --psy-rd 1.0 --qblur 0.2 --qcomp 0.9 --vbv-init 0.1 --aq-mode 1 --b-adapt 2 --bframes 6 --crf 20 --keyint 290 --lookahead-threads 3 --min-keyint 24 --qp 20 --qpstep 4 --qpmin 3 --qpmax 62 --rc-lookahead 48 --ref 4 --vbv-bufsize 1000 --deblock -2:-2 --me umh --overscan show --preset veryslow --scenecut 0 --tune psnr --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
