...
{ time x264  --no-weightb --aq-strength 3.0 --ipratio 1.4 --pbratio 1.3 --psy-rd 3.0 --qblur 0.4 --qcomp 0.8 --vbv-init 0.8 --aq-mode 0 --b-adapt 1 --bframes 8 --crf 45 --keyint 300 --lookahead-threads 1 --min-keyint 27 --qp 20 --qpstep 5 --qpmin 4 --qpmax 60 --rc-lookahead 18 --ref 3 --vbv-bufsize 2000 --deblock -1:-1 --me umh --overscan show --preset slow --scenecut 30 --tune animation --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
