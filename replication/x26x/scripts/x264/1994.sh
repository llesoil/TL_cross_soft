...
{ time x264  --aud --constrained-intra --slow-firstpass --no-weightb --aq-strength 2.0 --ipratio 1.3 --pbratio 1.3 --psy-rd 5.0 --qblur 0.4 --qcomp 0.9 --vbv-init 0.4 --aq-mode 1 --b-adapt 1 --bframes 4 --crf 40 --keyint 280 --lookahead-threads 1 --min-keyint 29 --qp 50 --qpstep 3 --qpmin 2 --qpmax 68 --rc-lookahead 28 --ref 5 --vbv-bufsize 2000 --deblock -1:-1 --me umh --overscan crop --preset faster --scenecut 40 --tune ssim --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
