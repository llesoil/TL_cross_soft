...
{ time x264  --aud --constrained-intra --weightb --aq-strength 1.5 --ipratio 1.2 --pbratio 1.2 --psy-rd 3.8 --qblur 0.4 --qcomp 0.6 --vbv-init 0.4 --aq-mode 1 --b-adapt 2 --bframes 12 --crf 45 --keyint 200 --lookahead-threads 4 --min-keyint 24 --qp 20 --qpstep 4 --qpmin 3 --qpmax 63 --rc-lookahead 48 --ref 4 --vbv-bufsize 2000 --deblock -2:-2 --me umh --overscan crop --preset slower --scenecut 0 --tune psnr --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
