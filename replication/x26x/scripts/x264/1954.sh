...
{ time x264  --constrained-intra --weightb --aq-strength 0.0 --ipratio 1.4 --pbratio 1.2 --psy-rd 3.8 --qblur 0.5 --qcomp 0.9 --vbv-init 0.5 --aq-mode 1 --b-adapt 2 --bframes 0 --crf 5 --keyint 270 --lookahead-threads 2 --min-keyint 22 --qp 10 --qpstep 3 --qpmin 3 --qpmax 60 --rc-lookahead 38 --ref 3 --vbv-bufsize 1000 --deblock -1:-1 --me umh --overscan show --preset fast --scenecut 10 --tune animation --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
