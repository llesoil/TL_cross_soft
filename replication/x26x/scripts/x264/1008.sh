...
{ time x264  --constrained-intra --no-weightb --aq-strength 0.5 --ipratio 1.3 --pbratio 1.2 --psy-rd 2.0 --qblur 0.6 --qcomp 0.9 --vbv-init 0.3 --aq-mode 0 --b-adapt 1 --bframes 2 --crf 20 --keyint 280 --lookahead-threads 0 --min-keyint 23 --qp 50 --qpstep 5 --qpmin 3 --qpmax 67 --rc-lookahead 38 --ref 4 --vbv-bufsize 2000 --deblock 1:1 --me dia --overscan crop --preset slower --scenecut 0 --tune ssim --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
