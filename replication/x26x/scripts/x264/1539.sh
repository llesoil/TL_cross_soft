...
{ time x264  --aud --no-asm --no-weightb --aq-strength 3.0 --ipratio 1.4 --pbratio 1.4 --psy-rd 0.8 --qblur 0.3 --qcomp 0.8 --vbv-init 0.9 --aq-mode 3 --b-adapt 1 --bframes 0 --crf 15 --keyint 280 --lookahead-threads 2 --min-keyint 21 --qp 10 --qpstep 4 --qpmin 4 --qpmax 60 --rc-lookahead 28 --ref 4 --vbv-bufsize 2000 --deblock -1:-1 --me umh --overscan show --preset veryfast --scenecut 30 --tune grain --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
