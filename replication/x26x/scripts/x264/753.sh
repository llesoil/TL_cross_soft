...
{ time x264  --aud --no-weightb --aq-strength 1.0 --ipratio 1.2 --pbratio 1.0 --psy-rd 2.4 --qblur 0.3 --qcomp 0.9 --vbv-init 0.1 --aq-mode 1 --b-adapt 0 --bframes 12 --crf 5 --keyint 270 --lookahead-threads 2 --min-keyint 22 --qp 30 --qpstep 4 --qpmin 0 --qpmax 61 --rc-lookahead 38 --ref 4 --vbv-bufsize 1000 --deblock -1:-1 --me hex --overscan crop --preset veryfast --scenecut 10 --tune ssim --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
