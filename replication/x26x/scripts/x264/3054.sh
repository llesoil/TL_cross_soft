...
{ time x264  --aud --no-asm --no-weightb --aq-strength 1.5 --ipratio 1.4 --pbratio 1.2 --psy-rd 4.2 --qblur 0.6 --qcomp 0.6 --vbv-init 0.8 --aq-mode 3 --b-adapt 0 --bframes 8 --crf 5 --keyint 250 --lookahead-threads 4 --min-keyint 29 --qp 50 --qpstep 5 --qpmin 4 --qpmax 62 --rc-lookahead 18 --ref 5 --vbv-bufsize 1000 --deblock -1:-1 --me umh --overscan crop --preset placebo --scenecut 0 --tune psnr --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
