...
{ time x264  --aud --no-weightb --aq-strength 0.0 --ipratio 1.5 --pbratio 1.2 --psy-rd 4.2 --qblur 0.6 --qcomp 0.9 --vbv-init 0.5 --aq-mode 1 --b-adapt 2 --bframes 6 --crf 0 --keyint 300 --lookahead-threads 1 --min-keyint 25 --qp 30 --qpstep 3 --qpmin 1 --qpmax 64 --rc-lookahead 48 --ref 6 --vbv-bufsize 1000 --deblock 1:1 --me dia --overscan show --preset placebo --scenecut 10 --tune grain --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
