...
{ time x264  --aud --constrained-intra --slow-firstpass --no-weightb --aq-strength 0.0 --ipratio 1.2 --pbratio 1.0 --psy-rd 0.8 --qblur 0.6 --qcomp 0.8 --vbv-init 0.6 --aq-mode 2 --b-adapt 0 --bframes 10 --crf 45 --keyint 270 --lookahead-threads 2 --min-keyint 26 --qp 30 --qpstep 4 --qpmin 1 --qpmax 65 --rc-lookahead 18 --ref 6 --vbv-bufsize 1000 --deblock -1:-1 --me dia --overscan show --preset medium --scenecut 40 --tune psnr --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
