...
{ time x264  --aud --no-asm --weightb --aq-strength 2.0 --ipratio 1.2 --pbratio 1.3 --psy-rd 4.8 --qblur 0.6 --qcomp 0.8 --vbv-init 0.4 --aq-mode 3 --b-adapt 2 --bframes 16 --crf 50 --keyint 200 --lookahead-threads 0 --min-keyint 25 --qp 50 --qpstep 3 --qpmin 0 --qpmax 69 --rc-lookahead 48 --ref 6 --vbv-bufsize 1000 --deblock -1:-1 --me hex --overscan show --preset faster --scenecut 10 --tune animation --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
