...
{ time x264  --constrained-intra --no-weightb --aq-strength 0.5 --ipratio 1.2 --pbratio 1.3 --psy-rd 1.2 --qblur 0.4 --qcomp 0.9 --vbv-init 0.6 --aq-mode 1 --b-adapt 1 --bframes 4 --crf 0 --keyint 250 --lookahead-threads 2 --min-keyint 29 --qp 0 --qpstep 3 --qpmin 4 --qpmax 68 --rc-lookahead 38 --ref 6 --vbv-bufsize 1000 --deblock -1:-1 --me dia --overscan crop --preset slow --scenecut 10 --tune animation --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
