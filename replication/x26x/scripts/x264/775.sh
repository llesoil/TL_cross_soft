...
{ time x264  --no-asm --no-weightb --aq-strength 2.0 --ipratio 1.3 --pbratio 1.4 --psy-rd 4.8 --qblur 0.5 --qcomp 0.8 --vbv-init 0.6 --aq-mode 3 --b-adapt 2 --bframes 0 --crf 20 --keyint 300 --lookahead-threads 4 --min-keyint 27 --qp 50 --qpstep 5 --qpmin 3 --qpmax 62 --rc-lookahead 28 --ref 4 --vbv-bufsize 2000 --deblock -1:-1 --me hex --overscan show --preset slow --scenecut 10 --tune psnr --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
