...
{ time x264  --no-weightb --aq-strength 0.5 --ipratio 1.3 --pbratio 1.2 --psy-rd 4.0 --qblur 0.4 --qcomp 0.6 --vbv-init 0.6 --aq-mode 1 --b-adapt 2 --bframes 16 --crf 0 --keyint 220 --lookahead-threads 1 --min-keyint 24 --qp 30 --qpstep 3 --qpmin 0 --qpmax 60 --rc-lookahead 48 --ref 6 --vbv-bufsize 1000 --deblock -2:-2 --me umh --overscan crop --preset medium --scenecut 10 --tune animation --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
