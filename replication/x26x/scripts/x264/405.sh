...
{ time x264  --no-weightb --aq-strength 3.0 --ipratio 1.3 --pbratio 1.0 --psy-rd 5.0 --qblur 0.3 --qcomp 0.8 --vbv-init 0.6 --aq-mode 2 --b-adapt 1 --bframes 12 --crf 25 --keyint 300 --lookahead-threads 1 --min-keyint 21 --qp 50 --qpstep 4 --qpmin 0 --qpmax 64 --rc-lookahead 38 --ref 5 --vbv-bufsize 2000 --deblock -2:-2 --me hex --overscan show --preset fast --scenecut 0 --tune psnr --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
