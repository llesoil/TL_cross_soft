...
{ time x264  --no-weightb --aq-strength 0.5 --ipratio 1.1 --pbratio 1.4 --psy-rd 1.8 --qblur 0.4 --qcomp 0.9 --vbv-init 0.2 --aq-mode 0 --b-adapt 1 --bframes 2 --crf 35 --keyint 290 --lookahead-threads 1 --min-keyint 23 --qp 40 --qpstep 4 --qpmin 1 --qpmax 62 --rc-lookahead 18 --ref 4 --vbv-bufsize 1000 --deblock -2:-2 --me dia --overscan show --preset faster --scenecut 30 --tune grain --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
