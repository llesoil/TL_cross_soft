...
{ time x264  --no-asm --weightb --aq-strength 1.0 --ipratio 1.5 --pbratio 1.3 --psy-rd 1.2 --qblur 0.6 --qcomp 0.6 --vbv-init 0.3 --aq-mode 0 --b-adapt 1 --bframes 12 --crf 45 --keyint 290 --lookahead-threads 2 --min-keyint 30 --qp 50 --qpstep 4 --qpmin 3 --qpmax 66 --rc-lookahead 18 --ref 1 --vbv-bufsize 1000 --deblock -2:-2 --me dia --overscan crop --preset veryslow --scenecut 30 --tune grain --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
