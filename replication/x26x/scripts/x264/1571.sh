...
{ time x264  --aud --constrained-intra --weightb --aq-strength 1.0 --ipratio 1.4 --pbratio 1.0 --psy-rd 2.8 --qblur 0.4 --qcomp 0.8 --vbv-init 0.4 --aq-mode 3 --b-adapt 0 --bframes 4 --crf 20 --keyint 250 --lookahead-threads 0 --min-keyint 29 --qp 0 --qpstep 5 --qpmin 1 --qpmax 65 --rc-lookahead 38 --ref 1 --vbv-bufsize 1000 --deblock -2:-2 --me umh --overscan crop --preset fast --scenecut 0 --tune animation --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
