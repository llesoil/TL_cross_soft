...
{ time x264  --constrained-intra --no-weightb --aq-strength 1.5 --ipratio 1.5 --pbratio 1.3 --psy-rd 3.4 --qblur 0.4 --qcomp 0.8 --vbv-init 0.3 --aq-mode 1 --b-adapt 2 --bframes 10 --crf 45 --keyint 200 --lookahead-threads 2 --min-keyint 25 --qp 10 --qpstep 5 --qpmin 1 --qpmax 63 --rc-lookahead 18 --ref 4 --vbv-bufsize 1000 --deblock -1:-1 --me dia --overscan show --preset superfast --scenecut 30 --tune psnr --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
