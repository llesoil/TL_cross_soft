...
{ time x264  --aud --weightb --aq-strength 0.5 --ipratio 1.6 --pbratio 1.1 --psy-rd 4.8 --qblur 0.4 --qcomp 0.6 --vbv-init 0.9 --aq-mode 0 --b-adapt 2 --bframes 0 --crf 5 --keyint 260 --lookahead-threads 4 --min-keyint 20 --qp 30 --qpstep 3 --qpmin 1 --qpmax 64 --rc-lookahead 28 --ref 4 --vbv-bufsize 2000 --deblock 1:1 --me umh --overscan crop --preset faster --scenecut 10 --tune ssim --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
