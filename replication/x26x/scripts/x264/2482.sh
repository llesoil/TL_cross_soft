...
{ time x264  --aud --constrained-intra --weightb --aq-strength 1.5 --ipratio 1.4 --pbratio 1.3 --psy-rd 2.8 --qblur 0.6 --qcomp 0.6 --vbv-init 0.5 --aq-mode 3 --b-adapt 2 --bframes 0 --crf 20 --keyint 260 --lookahead-threads 0 --min-keyint 28 --qp 20 --qpstep 5 --qpmin 1 --qpmax 67 --rc-lookahead 38 --ref 4 --vbv-bufsize 2000 --deblock -1:-1 --me hex --overscan crop --preset slower --scenecut 30 --tune animation --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
