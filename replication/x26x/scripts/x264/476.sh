...
{ time x264  --no-asm --slow-firstpass --no-weightb --aq-strength 1.5 --ipratio 1.4 --pbratio 1.3 --psy-rd 0.4 --qblur 0.3 --qcomp 0.9 --vbv-init 0.9 --aq-mode 3 --b-adapt 2 --bframes 10 --crf 0 --keyint 290 --lookahead-threads 1 --min-keyint 26 --qp 50 --qpstep 3 --qpmin 2 --qpmax 65 --rc-lookahead 38 --ref 4 --vbv-bufsize 2000 --deblock -2:-2 --me hex --overscan show --preset slower --scenecut 10 --tune ssim --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
