...
{ time x264  --constrained-intra --no-asm --no-weightb --aq-strength 1.0 --ipratio 1.6 --pbratio 1.3 --psy-rd 4.4 --qblur 0.4 --qcomp 0.8 --vbv-init 0.1 --aq-mode 2 --b-adapt 0 --bframes 0 --crf 0 --keyint 270 --lookahead-threads 1 --min-keyint 24 --qp 40 --qpstep 3 --qpmin 2 --qpmax 66 --rc-lookahead 28 --ref 3 --vbv-bufsize 1000 --deblock -2:-2 --me dia --overscan show --preset superfast --scenecut 30 --tune animation --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
