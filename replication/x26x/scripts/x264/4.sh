...
{ time x264  --no-asm --weightb --aq-strength 0.5 --ipratio 1.5 --pbratio 1.2 --psy-rd 0.8 --qblur 0.3 --qcomp 0.6 --vbv-init 0.1 --aq-mode 1 --b-adapt 2 --bframes 16 --crf 10 --keyint 300 --lookahead-threads 4 --min-keyint 21 --qp 30 --qpstep 5 --qpmin 2 --qpmax 68 --rc-lookahead 18 --ref 1 --vbv-bufsize 1000 --deblock -2:-2 --me umh --overscan crop --preset slower --scenecut 30 --tune grain --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
