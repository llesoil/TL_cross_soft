...
{ time x264  --constrained-intra --no-weightb --aq-strength 1.0 --ipratio 1.0 --pbratio 1.1 --psy-rd 2.2 --qblur 0.4 --qcomp 0.6 --vbv-init 0.3 --aq-mode 3 --b-adapt 1 --bframes 14 --crf 45 --keyint 290 --lookahead-threads 0 --min-keyint 21 --qp 30 --qpstep 3 --qpmin 4 --qpmax 63 --rc-lookahead 18 --ref 5 --vbv-bufsize 2000 --deblock -2:-2 --me umh --overscan crop --preset fast --scenecut 0 --tune grain --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
