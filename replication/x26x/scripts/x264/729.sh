...
{ time x264  --constrained-intra --no-asm --no-weightb --aq-strength 3.0 --ipratio 1.4 --pbratio 1.0 --psy-rd 2.2 --qblur 0.4 --qcomp 0.9 --vbv-init 0.3 --aq-mode 2 --b-adapt 2 --bframes 10 --crf 50 --keyint 290 --lookahead-threads 2 --min-keyint 30 --qp 50 --qpstep 5 --qpmin 1 --qpmax 67 --rc-lookahead 48 --ref 5 --vbv-bufsize 1000 --deblock -2:-2 --me hex --overscan crop --preset superfast --scenecut 40 --tune grain --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
