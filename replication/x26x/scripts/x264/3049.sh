...
{ time x264  --constrained-intra --no-asm --no-weightb --aq-strength 0.0 --ipratio 1.0 --pbratio 1.4 --psy-rd 2.6 --qblur 0.4 --qcomp 0.9 --vbv-init 0.3 --aq-mode 3 --b-adapt 1 --bframes 6 --crf 0 --keyint 200 --lookahead-threads 2 --min-keyint 26 --qp 50 --qpstep 4 --qpmin 1 --qpmax 63 --rc-lookahead 38 --ref 2 --vbv-bufsize 1000 --deblock -1:-1 --me hex --overscan show --preset slower --scenecut 30 --tune ssim --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
