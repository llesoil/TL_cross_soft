...
{ time x264  --no-asm --no-weightb --aq-strength 3.0 --ipratio 1.2 --pbratio 1.3 --psy-rd 4.8 --qblur 0.4 --qcomp 0.6 --vbv-init 0.2 --aq-mode 1 --b-adapt 2 --bframes 12 --crf 5 --keyint 280 --lookahead-threads 4 --min-keyint 27 --qp 40 --qpstep 3 --qpmin 1 --qpmax 60 --rc-lookahead 38 --ref 1 --vbv-bufsize 1000 --deblock -1:-1 --me umh --overscan show --preset placebo --scenecut 10 --tune animation --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
