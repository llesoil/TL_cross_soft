...
{ time x264  --no-asm --no-weightb --aq-strength 1.0 --ipratio 1.1 --pbratio 1.2 --psy-rd 0.4 --qblur 0.6 --qcomp 0.8 --vbv-init 0.4 --aq-mode 1 --b-adapt 1 --bframes 4 --crf 5 --keyint 270 --lookahead-threads 2 --min-keyint 23 --qp 20 --qpstep 3 --qpmin 1 --qpmax 62 --rc-lookahead 18 --ref 5 --vbv-bufsize 1000 --deblock 1:1 --me umh --overscan crop --preset fast --scenecut 0 --tune grain --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
