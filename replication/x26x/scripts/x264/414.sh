...
{ time x264  --aud --weightb --aq-strength 1.5 --ipratio 1.6 --pbratio 1.1 --psy-rd 1.4 --qblur 0.6 --qcomp 0.6 --vbv-init 0.1 --aq-mode 0 --b-adapt 1 --bframes 16 --crf 25 --keyint 260 --lookahead-threads 2 --min-keyint 26 --qp 50 --qpstep 4 --qpmin 1 --qpmax 60 --rc-lookahead 38 --ref 6 --vbv-bufsize 1000 --deblock -1:-1 --me umh --overscan crop --preset slow --scenecut 40 --tune ssim --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
