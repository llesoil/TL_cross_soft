...
{ time x264  --aud --constrained-intra --no-asm --weightb --aq-strength 1.0 --ipratio 1.0 --pbratio 1.3 --psy-rd 1.8 --qblur 0.5 --qcomp 0.6 --vbv-init 0.6 --aq-mode 0 --b-adapt 1 --bframes 0 --crf 35 --keyint 200 --lookahead-threads 1 --min-keyint 30 --qp 50 --qpstep 4 --qpmin 1 --qpmax 62 --rc-lookahead 38 --ref 4 --vbv-bufsize 1000 --deblock 1:1 --me hex --overscan crop --preset veryslow --scenecut 40 --tune grain --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
