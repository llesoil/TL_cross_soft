...
{ time x264  --aud --constrained-intra --no-weightb --aq-strength 1.0 --ipratio 1.4 --pbratio 1.1 --psy-rd 1.2 --qblur 0.4 --qcomp 0.9 --vbv-init 0.0 --aq-mode 1 --b-adapt 1 --bframes 4 --crf 5 --keyint 200 --lookahead-threads 2 --min-keyint 29 --qp 0 --qpstep 5 --qpmin 3 --qpmax 64 --rc-lookahead 18 --ref 6 --vbv-bufsize 1000 --deblock -1:-1 --me hex --overscan show --preset faster --scenecut 30 --tune animation --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
