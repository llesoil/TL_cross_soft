...
{ time x264  --aud --constrained-intra --no-asm --weightb --aq-strength 2.5 --ipratio 1.4 --pbratio 1.4 --psy-rd 0.2 --qblur 0.6 --qcomp 0.8 --vbv-init 0.8 --aq-mode 3 --b-adapt 0 --bframes 6 --crf 25 --keyint 280 --lookahead-threads 0 --min-keyint 27 --qp 50 --qpstep 5 --qpmin 1 --qpmax 66 --rc-lookahead 48 --ref 1 --vbv-bufsize 1000 --deblock -2:-2 --me hex --overscan crop --preset veryslow --scenecut 0 --tune ssim --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
