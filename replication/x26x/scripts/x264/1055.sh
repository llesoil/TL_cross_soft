...
{ time x264  --weightb --aq-strength 0.0 --ipratio 1.5 --pbratio 1.3 --psy-rd 3.6 --qblur 0.4 --qcomp 0.9 --vbv-init 0.9 --aq-mode 2 --b-adapt 0 --bframes 0 --crf 10 --keyint 200 --lookahead-threads 4 --min-keyint 27 --qp 30 --qpstep 5 --qpmin 2 --qpmax 62 --rc-lookahead 18 --ref 6 --vbv-bufsize 2000 --deblock -2:-2 --me hex --overscan show --preset fast --scenecut 30 --tune grain --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
