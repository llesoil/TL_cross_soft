...
{ time x264  --no-asm --no-weightb --aq-strength 1.0 --ipratio 1.1 --pbratio 1.2 --psy-rd 3.4 --qblur 0.6 --qcomp 0.6 --vbv-init 0.5 --aq-mode 1 --b-adapt 0 --bframes 12 --crf 45 --keyint 250 --lookahead-threads 2 --min-keyint 26 --qp 30 --qpstep 4 --qpmin 3 --qpmax 63 --rc-lookahead 18 --ref 3 --vbv-bufsize 1000 --deblock 1:1 --me umh --overscan crop --preset fast --scenecut 30 --tune ssim --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
