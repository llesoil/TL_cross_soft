...
{ time x264  --constrained-intra --weightb --aq-strength 3.0 --ipratio 1.1 --pbratio 1.3 --psy-rd 5.0 --qblur 0.2 --qcomp 0.9 --vbv-init 0.1 --aq-mode 3 --b-adapt 0 --bframes 2 --crf 25 --keyint 290 --lookahead-threads 4 --min-keyint 26 --qp 40 --qpstep 3 --qpmin 1 --qpmax 67 --rc-lookahead 18 --ref 6 --vbv-bufsize 2000 --deblock 1:1 --me hex --overscan crop --preset faster --scenecut 40 --tune grain --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
