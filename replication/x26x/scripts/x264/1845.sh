...
{ time x264  --constrained-intra --no-asm --no-weightb --aq-strength 2.5 --ipratio 1.3 --pbratio 1.0 --psy-rd 1.8 --qblur 0.5 --qcomp 0.9 --vbv-init 0.0 --aq-mode 1 --b-adapt 1 --bframes 8 --crf 10 --keyint 290 --lookahead-threads 2 --min-keyint 23 --qp 30 --qpstep 5 --qpmin 3 --qpmax 61 --rc-lookahead 48 --ref 4 --vbv-bufsize 1000 --deblock 1:1 --me umh --overscan show --preset ultrafast --scenecut 40 --tune animation --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
