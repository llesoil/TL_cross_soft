...
{ time x264  --constrained-intra --no-weightb --aq-strength 3.0 --ipratio 1.0 --pbratio 1.0 --psy-rd 5.0 --qblur 0.3 --qcomp 0.6 --vbv-init 0.1 --aq-mode 3 --b-adapt 1 --bframes 10 --crf 0 --keyint 250 --lookahead-threads 1 --min-keyint 21 --qp 30 --qpstep 4 --qpmin 1 --qpmax 67 --rc-lookahead 18 --ref 2 --vbv-bufsize 1000 --deblock 1:1 --me umh --overscan crop --preset slow --scenecut 40 --tune animation --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
