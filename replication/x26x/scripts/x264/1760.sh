...
{ time x264  --aud --no-asm --weightb --aq-strength 0.0 --ipratio 1.2 --pbratio 1.3 --psy-rd 3.0 --qblur 0.5 --qcomp 0.8 --vbv-init 0.6 --aq-mode 2 --b-adapt 2 --bframes 8 --crf 5 --keyint 260 --lookahead-threads 2 --min-keyint 28 --qp 50 --qpstep 5 --qpmin 1 --qpmax 63 --rc-lookahead 38 --ref 1 --vbv-bufsize 1000 --deblock 1:1 --me dia --overscan show --preset faster --scenecut 40 --tune grain --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
