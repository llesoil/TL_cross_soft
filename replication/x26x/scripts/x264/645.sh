...
{ time x264  --constrained-intra --no-asm --weightb --aq-strength 3.0 --ipratio 1.6 --pbratio 1.1 --psy-rd 3.2 --qblur 0.5 --qcomp 0.9 --vbv-init 0.3 --aq-mode 0 --b-adapt 2 --bframes 8 --crf 20 --keyint 290 --lookahead-threads 1 --min-keyint 29 --qp 0 --qpstep 5 --qpmin 1 --qpmax 60 --rc-lookahead 48 --ref 4 --vbv-bufsize 1000 --deblock -2:-2 --me dia --overscan crop --preset fast --scenecut 0 --tune psnr --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
