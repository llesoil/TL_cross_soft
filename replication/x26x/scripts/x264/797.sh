...
{ time x264  --aud --constrained-intra --weightb --aq-strength 2.0 --ipratio 1.5 --pbratio 1.2 --psy-rd 3.4 --qblur 0.2 --qcomp 0.8 --vbv-init 0.1 --aq-mode 0 --b-adapt 2 --bframes 10 --crf 25 --keyint 200 --lookahead-threads 2 --min-keyint 24 --qp 40 --qpstep 4 --qpmin 4 --qpmax 61 --rc-lookahead 48 --ref 5 --vbv-bufsize 2000 --deblock 1:1 --me umh --overscan crop --preset ultrafast --scenecut 0 --tune grain --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
