...
{ time x264  --constrained-intra --weightb --aq-strength 0.5 --ipratio 1.1 --pbratio 1.1 --psy-rd 2.6 --qblur 0.6 --qcomp 0.9 --vbv-init 0.1 --aq-mode 3 --b-adapt 0 --bframes 12 --crf 50 --keyint 290 --lookahead-threads 1 --min-keyint 26 --qp 20 --qpstep 4 --qpmin 0 --qpmax 60 --rc-lookahead 48 --ref 2 --vbv-bufsize 1000 --deblock -2:-2 --me hex --overscan crop --preset faster --scenecut 10 --tune animation --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
