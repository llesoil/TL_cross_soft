...
{ time x264  --constrained-intra --weightb --aq-strength 1.0 --ipratio 1.1 --pbratio 1.3 --psy-rd 2.6 --qblur 0.5 --qcomp 0.8 --vbv-init 0.6 --aq-mode 1 --b-adapt 0 --bframes 6 --crf 5 --keyint 260 --lookahead-threads 0 --min-keyint 25 --qp 50 --qpstep 5 --qpmin 1 --qpmax 64 --rc-lookahead 38 --ref 3 --vbv-bufsize 2000 --deblock -2:-2 --me hex --overscan show --preset slow --scenecut 10 --tune animation --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
