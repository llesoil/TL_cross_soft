...
{ time x264  --no-asm --no-weightb --aq-strength 0.0 --ipratio 1.5 --pbratio 1.3 --psy-rd 4.8 --qblur 0.5 --qcomp 0.8 --vbv-init 0.6 --aq-mode 2 --b-adapt 1 --bframes 12 --crf 50 --keyint 220 --lookahead-threads 2 --min-keyint 27 --qp 30 --qpstep 5 --qpmin 4 --qpmax 66 --rc-lookahead 48 --ref 3 --vbv-bufsize 2000 --deblock -2:-2 --me dia --overscan crop --preset faster --scenecut 0 --tune psnr --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
