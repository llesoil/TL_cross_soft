...
{ time x264  --aud --no-asm --slow-firstpass --no-weightb --aq-strength 1.0 --ipratio 1.2 --pbratio 1.1 --psy-rd 3.8 --qblur 0.5 --qcomp 0.6 --vbv-init 0.6 --aq-mode 1 --b-adapt 2 --bframes 2 --crf 25 --keyint 270 --lookahead-threads 4 --min-keyint 28 --qp 50 --qpstep 3 --qpmin 0 --qpmax 68 --rc-lookahead 48 --ref 2 --vbv-bufsize 2000 --deblock -2:-2 --me hex --overscan show --preset superfast --scenecut 0 --tune grain --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
