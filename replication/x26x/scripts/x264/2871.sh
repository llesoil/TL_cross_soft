...
{ time x264  --aud --constrained-intra --weightb --aq-strength 3.0 --ipratio 1.6 --pbratio 1.4 --psy-rd 5.0 --qblur 0.5 --qcomp 0.6 --vbv-init 0.2 --aq-mode 2 --b-adapt 0 --bframes 8 --crf 20 --keyint 270 --lookahead-threads 2 --min-keyint 27 --qp 30 --qpstep 4 --qpmin 3 --qpmax 68 --rc-lookahead 38 --ref 5 --vbv-bufsize 2000 --deblock 1:1 --me umh --overscan crop --preset veryfast --scenecut 40 --tune grain --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
