...
{ time x264  --constrained-intra --no-asm --weightb --aq-strength 1.5 --ipratio 1.1 --pbratio 1.3 --psy-rd 4.6 --qblur 0.6 --qcomp 0.9 --vbv-init 0.8 --aq-mode 0 --b-adapt 2 --bframes 8 --crf 5 --keyint 300 --lookahead-threads 1 --min-keyint 24 --qp 50 --qpstep 5 --qpmin 3 --qpmax 60 --rc-lookahead 28 --ref 4 --vbv-bufsize 2000 --deblock -2:-2 --me umh --overscan show --preset superfast --scenecut 0 --tune grain --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
