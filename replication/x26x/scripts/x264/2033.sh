...
{ time x264  --aud --no-weightb --aq-strength 3.0 --ipratio 1.5 --pbratio 1.1 --psy-rd 0.6 --qblur 0.6 --qcomp 0.6 --vbv-init 0.1 --aq-mode 1 --b-adapt 1 --bframes 0 --crf 40 --keyint 300 --lookahead-threads 2 --min-keyint 21 --qp 30 --qpstep 5 --qpmin 3 --qpmax 66 --rc-lookahead 18 --ref 5 --vbv-bufsize 2000 --deblock -1:-1 --me hex --overscan crop --preset slow --scenecut 40 --tune animation --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
