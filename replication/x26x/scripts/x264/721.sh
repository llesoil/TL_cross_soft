...
{ time x264  --aud --no-weightb --aq-strength 1.5 --ipratio 1.4 --pbratio 1.4 --psy-rd 4.0 --qblur 0.6 --qcomp 0.6 --vbv-init 0.5 --aq-mode 2 --b-adapt 1 --bframes 12 --crf 40 --keyint 260 --lookahead-threads 2 --min-keyint 24 --qp 50 --qpstep 5 --qpmin 1 --qpmax 60 --rc-lookahead 18 --ref 4 --vbv-bufsize 1000 --deblock -1:-1 --me umh --overscan crop --preset placebo --scenecut 0 --tune animation --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
