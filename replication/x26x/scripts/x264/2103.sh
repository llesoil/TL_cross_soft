...
{ time x264  --aud --no-weightb --aq-strength 3.0 --ipratio 1.2 --pbratio 1.0 --psy-rd 2.2 --qblur 0.2 --qcomp 0.9 --vbv-init 0.1 --aq-mode 0 --b-adapt 0 --bframes 14 --crf 15 --keyint 200 --lookahead-threads 0 --min-keyint 29 --qp 30 --qpstep 5 --qpmin 4 --qpmax 65 --rc-lookahead 38 --ref 3 --vbv-bufsize 1000 --deblock 1:1 --me hex --overscan crop --preset slow --scenecut 40 --tune psnr --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
