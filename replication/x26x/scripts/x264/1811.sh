...
{ time x264  --aud --slow-firstpass --no-weightb --aq-strength 1.5 --ipratio 1.0 --pbratio 1.1 --psy-rd 3.8 --qblur 0.6 --qcomp 0.9 --vbv-init 0.8 --aq-mode 3 --b-adapt 0 --bframes 16 --crf 15 --keyint 220 --lookahead-threads 1 --min-keyint 24 --qp 20 --qpstep 5 --qpmin 4 --qpmax 61 --rc-lookahead 18 --ref 2 --vbv-bufsize 2000 --deblock -2:-2 --me hex --overscan show --preset placebo --scenecut 0 --tune animation --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
