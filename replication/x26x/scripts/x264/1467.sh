...
{ time x264  --aud --constrained-intra --weightb --aq-strength 1.0 --ipratio 1.6 --pbratio 1.4 --psy-rd 2.6 --qblur 0.6 --qcomp 0.9 --vbv-init 0.4 --aq-mode 2 --b-adapt 1 --bframes 4 --crf 0 --keyint 300 --lookahead-threads 2 --min-keyint 28 --qp 40 --qpstep 4 --qpmin 1 --qpmax 64 --rc-lookahead 38 --ref 2 --vbv-bufsize 2000 --deblock -1:-1 --me dia --overscan show --preset slow --scenecut 40 --tune ssim --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
