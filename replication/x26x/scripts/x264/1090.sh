...
{ time x264  --aud --weightb --aq-strength 2.0 --ipratio 1.5 --pbratio 1.4 --psy-rd 0.8 --qblur 0.3 --qcomp 0.6 --vbv-init 0.1 --aq-mode 2 --b-adapt 0 --bframes 2 --crf 5 --keyint 270 --lookahead-threads 4 --min-keyint 27 --qp 30 --qpstep 3 --qpmin 2 --qpmax 66 --rc-lookahead 28 --ref 4 --vbv-bufsize 2000 --deblock -2:-2 --me umh --overscan show --preset faster --scenecut 40 --tune ssim --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
