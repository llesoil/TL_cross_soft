...
{ time x264  --aud --no-weightb --aq-strength 1.0 --ipratio 1.2 --pbratio 1.4 --psy-rd 0.8 --qblur 0.3 --qcomp 0.8 --vbv-init 0.5 --aq-mode 0 --b-adapt 1 --bframes 8 --crf 40 --keyint 270 --lookahead-threads 0 --min-keyint 25 --qp 20 --qpstep 5 --qpmin 1 --qpmax 63 --rc-lookahead 18 --ref 3 --vbv-bufsize 1000 --deblock 1:1 --me dia --overscan crop --preset veryfast --scenecut 30 --tune ssim --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
