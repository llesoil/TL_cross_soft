...
{ time x264  --no-asm --no-weightb --aq-strength 2.0 --ipratio 1.5 --pbratio 1.3 --psy-rd 1.8 --qblur 0.4 --qcomp 0.9 --vbv-init 0.8 --aq-mode 2 --b-adapt 0 --bframes 16 --crf 10 --keyint 200 --lookahead-threads 1 --min-keyint 24 --qp 50 --qpstep 4 --qpmin 3 --qpmax 68 --rc-lookahead 18 --ref 4 --vbv-bufsize 1000 --deblock 1:1 --me dia --overscan show --preset faster --scenecut 10 --tune psnr --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
