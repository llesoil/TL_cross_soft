...
{ time x264  --constrained-intra --no-weightb --aq-strength 2.5 --ipratio 1.4 --pbratio 1.4 --psy-rd 3.8 --qblur 0.2 --qcomp 0.9 --vbv-init 0.5 --aq-mode 1 --b-adapt 1 --bframes 12 --crf 5 --keyint 260 --lookahead-threads 0 --min-keyint 25 --qp 20 --qpstep 4 --qpmin 0 --qpmax 60 --rc-lookahead 38 --ref 1 --vbv-bufsize 2000 --deblock -2:-2 --me umh --overscan crop --preset veryslow --scenecut 10 --tune grain --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
