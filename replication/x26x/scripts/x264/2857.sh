...
{ time x264  --aud --no-asm --no-weightb --aq-strength 3.0 --ipratio 1.6 --pbratio 1.2 --psy-rd 1.6 --qblur 0.5 --qcomp 0.8 --vbv-init 0.1 --aq-mode 1 --b-adapt 1 --bframes 12 --crf 0 --keyint 260 --lookahead-threads 0 --min-keyint 20 --qp 30 --qpstep 3 --qpmin 4 --qpmax 61 --rc-lookahead 28 --ref 5 --vbv-bufsize 2000 --deblock 1:1 --me umh --overscan show --preset ultrafast --scenecut 0 --tune grain --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
