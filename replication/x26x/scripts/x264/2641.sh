...
{ time x264  --weightb --aq-strength 3.0 --ipratio 1.6 --pbratio 1.3 --psy-rd 4.2 --qblur 0.3 --qcomp 0.6 --vbv-init 0.1 --aq-mode 2 --b-adapt 1 --bframes 14 --crf 40 --keyint 200 --lookahead-threads 1 --min-keyint 27 --qp 30 --qpstep 4 --qpmin 4 --qpmax 61 --rc-lookahead 18 --ref 6 --vbv-bufsize 1000 --deblock 1:1 --me dia --overscan crop --preset fast --scenecut 10 --tune animation --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
