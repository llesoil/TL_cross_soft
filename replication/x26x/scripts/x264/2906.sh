...
{ time x264  --constrained-intra --no-asm --weightb --aq-strength 1.0 --ipratio 1.2 --pbratio 1.0 --psy-rd 1.2 --qblur 0.6 --qcomp 0.8 --vbv-init 0.6 --aq-mode 2 --b-adapt 0 --bframes 0 --crf 50 --keyint 280 --lookahead-threads 0 --min-keyint 21 --qp 50 --qpstep 5 --qpmin 0 --qpmax 62 --rc-lookahead 48 --ref 2 --vbv-bufsize 1000 --deblock -2:-2 --me dia --overscan show --preset medium --scenecut 40 --tune psnr --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
