...
{ time x264  --weightb --aq-strength 3.0 --ipratio 1.4 --pbratio 1.4 --psy-rd 1.2 --qblur 0.2 --qcomp 0.6 --vbv-init 0.5 --aq-mode 0 --b-adapt 0 --bframes 4 --crf 40 --keyint 220 --lookahead-threads 1 --min-keyint 27 --qp 50 --qpstep 3 --qpmin 1 --qpmax 66 --rc-lookahead 38 --ref 6 --vbv-bufsize 1000 --deblock -2:-2 --me umh --overscan crop --preset faster --scenecut 0 --tune ssim --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
