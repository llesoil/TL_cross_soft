...
{ time x264  --aud --constrained-intra --no-weightb --aq-strength 1.0 --ipratio 1.5 --pbratio 1.0 --psy-rd 0.8 --qblur 0.2 --qcomp 0.9 --vbv-init 0.2 --aq-mode 1 --b-adapt 1 --bframes 12 --crf 45 --keyint 300 --lookahead-threads 4 --min-keyint 26 --qp 50 --qpstep 3 --qpmin 0 --qpmax 62 --rc-lookahead 28 --ref 4 --vbv-bufsize 1000 --deblock -2:-2 --me umh --overscan show --preset veryslow --scenecut 40 --tune grain --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
