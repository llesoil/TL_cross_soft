...
{ time x264  --aud --no-asm --weightb --aq-strength 0.5 --ipratio 1.1 --pbratio 1.3 --psy-rd 0.6 --qblur 0.4 --qcomp 0.9 --vbv-init 0.9 --aq-mode 1 --b-adapt 0 --bframes 0 --crf 5 --keyint 300 --lookahead-threads 0 --min-keyint 21 --qp 40 --qpstep 3 --qpmin 1 --qpmax 61 --rc-lookahead 18 --ref 4 --vbv-bufsize 1000 --deblock 1:1 --me hex --overscan show --preset slow --scenecut 10 --tune psnr --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
