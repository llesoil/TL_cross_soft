...
{ time x264  --constrained-intra --no-asm --slow-firstpass --no-weightb --aq-strength 2.0 --ipratio 1.3 --pbratio 1.0 --psy-rd 2.2 --qblur 0.5 --qcomp 0.6 --vbv-init 0.8 --aq-mode 3 --b-adapt 2 --bframes 6 --crf 15 --keyint 260 --lookahead-threads 2 --min-keyint 24 --qp 20 --qpstep 4 --qpmin 3 --qpmax 68 --rc-lookahead 48 --ref 5 --vbv-bufsize 2000 --deblock 1:1 --me hex --overscan show --preset ultrafast --scenecut 10 --tune animation --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
