...
{ time x264  --aud --constrained-intra --slow-firstpass --no-weightb --aq-strength 0.5 --ipratio 1.2 --pbratio 1.0 --psy-rd 2.6 --qblur 0.6 --qcomp 0.9 --vbv-init 0.5 --aq-mode 2 --b-adapt 1 --bframes 0 --crf 0 --keyint 290 --lookahead-threads 0 --min-keyint 20 --qp 0 --qpstep 3 --qpmin 1 --qpmax 66 --rc-lookahead 48 --ref 1 --vbv-bufsize 1000 --deblock -1:-1 --me umh --overscan crop --preset placebo --scenecut 10 --tune ssim --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
