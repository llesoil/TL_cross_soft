...
{ time x264  --no-asm --slow-firstpass --no-weightb --aq-strength 0.5 --ipratio 1.6 --pbratio 1.3 --psy-rd 2.8 --qblur 0.2 --qcomp 0.8 --vbv-init 0.0 --aq-mode 1 --b-adapt 1 --bframes 4 --crf 45 --keyint 300 --lookahead-threads 0 --min-keyint 29 --qp 10 --qpstep 5 --qpmin 0 --qpmax 69 --rc-lookahead 18 --ref 3 --vbv-bufsize 2000 --deblock -1:-1 --me dia --overscan crop --preset ultrafast --scenecut 40 --tune ssim --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
