...
{ time x264  --constrained-intra --no-asm --no-weightb --aq-strength 0.5 --ipratio 1.5 --pbratio 1.4 --psy-rd 4.2 --qblur 0.3 --qcomp 0.6 --vbv-init 0.1 --aq-mode 0 --b-adapt 2 --bframes 0 --crf 40 --keyint 250 --lookahead-threads 1 --min-keyint 23 --qp 30 --qpstep 5 --qpmin 1 --qpmax 65 --rc-lookahead 48 --ref 3 --vbv-bufsize 2000 --deblock -2:-2 --me umh --overscan show --preset fast --scenecut 40 --tune psnr --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
