...
{ time x264  --no-asm --no-weightb --aq-strength 2.5 --ipratio 1.0 --pbratio 1.0 --psy-rd 3.6 --qblur 0.4 --qcomp 0.6 --vbv-init 0.8 --aq-mode 0 --b-adapt 0 --bframes 8 --crf 15 --keyint 250 --lookahead-threads 2 --min-keyint 29 --qp 50 --qpstep 5 --qpmin 1 --qpmax 68 --rc-lookahead 28 --ref 4 --vbv-bufsize 2000 --deblock -2:-2 --me umh --overscan crop --preset veryslow --scenecut 0 --tune grain --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
