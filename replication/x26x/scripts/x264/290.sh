...
{ time x264  --aud --constrained-intra --no-asm --slow-firstpass --no-weightb --aq-strength 0.5 --ipratio 1.3 --pbratio 1.4 --psy-rd 0.2 --qblur 0.4 --qcomp 0.6 --vbv-init 0.8 --aq-mode 3 --b-adapt 0 --bframes 2 --crf 45 --keyint 220 --lookahead-threads 2 --min-keyint 24 --qp 40 --qpstep 5 --qpmin 3 --qpmax 64 --rc-lookahead 38 --ref 1 --vbv-bufsize 1000 --deblock -2:-2 --me hex --overscan show --preset fast --scenecut 40 --tune animation --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
