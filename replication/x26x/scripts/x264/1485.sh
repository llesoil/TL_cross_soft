...
{ time x264  --aud --no-asm --weightb --aq-strength 1.5 --ipratio 1.5 --pbratio 1.0 --psy-rd 1.2 --qblur 0.4 --qcomp 0.6 --vbv-init 0.4 --aq-mode 3 --b-adapt 1 --bframes 6 --crf 5 --keyint 260 --lookahead-threads 1 --min-keyint 29 --qp 50 --qpstep 4 --qpmin 2 --qpmax 60 --rc-lookahead 48 --ref 6 --vbv-bufsize 2000 --deblock 1:1 --me dia --overscan crop --preset veryfast --scenecut 40 --tune grain --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
