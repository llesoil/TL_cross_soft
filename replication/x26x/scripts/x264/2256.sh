...
{ time x264  --aud --constrained-intra --slow-firstpass --no-weightb --aq-strength 2.5 --ipratio 1.2 --pbratio 1.0 --psy-rd 4.8 --qblur 0.4 --qcomp 0.9 --vbv-init 0.2 --aq-mode 2 --b-adapt 1 --bframes 12 --crf 35 --keyint 300 --lookahead-threads 0 --min-keyint 28 --qp 30 --qpstep 4 --qpmin 4 --qpmax 65 --rc-lookahead 48 --ref 6 --vbv-bufsize 1000 --deblock 1:1 --me hex --overscan show --preset slow --scenecut 0 --tune animation --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
