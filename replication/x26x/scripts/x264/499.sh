...
{ time x264  --aud --constrained-intra --no-asm --weightb --aq-strength 0.5 --ipratio 1.6 --pbratio 1.0 --psy-rd 4.8 --qblur 0.3 --qcomp 0.8 --vbv-init 0.4 --aq-mode 0 --b-adapt 1 --bframes 2 --crf 25 --keyint 290 --lookahead-threads 0 --min-keyint 24 --qp 50 --qpstep 4 --qpmin 0 --qpmax 60 --rc-lookahead 48 --ref 6 --vbv-bufsize 2000 --deblock -2:-2 --me hex --overscan crop --preset superfast --scenecut 40 --tune psnr --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
