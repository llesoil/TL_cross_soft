...
{ time x264  --aud --constrained-intra --weightb --aq-strength 1.5 --ipratio 1.1 --pbratio 1.2 --psy-rd 3.8 --qblur 0.3 --qcomp 0.8 --vbv-init 0.5 --aq-mode 3 --b-adapt 2 --bframes 14 --crf 45 --keyint 280 --lookahead-threads 0 --min-keyint 26 --qp 40 --qpstep 3 --qpmin 1 --qpmax 66 --rc-lookahead 48 --ref 3 --vbv-bufsize 2000 --deblock -2:-2 --me umh --overscan crop --preset superfast --scenecut 10 --tune grain --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
