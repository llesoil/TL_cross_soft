...
{ time x264  --aud --no-asm --slow-firstpass --no-weightb --aq-strength 0.5 --ipratio 1.3 --pbratio 1.1 --psy-rd 2.8 --qblur 0.5 --qcomp 0.9 --vbv-init 0.6 --aq-mode 3 --b-adapt 2 --bframes 6 --crf 0 --keyint 290 --lookahead-threads 2 --min-keyint 22 --qp 30 --qpstep 4 --qpmin 1 --qpmax 65 --rc-lookahead 48 --ref 5 --vbv-bufsize 2000 --deblock 1:1 --me umh --overscan crop --preset slower --scenecut 40 --tune psnr --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
