...
{ time x264  --aud --no-weightb --aq-strength 2.0 --ipratio 1.5 --pbratio 1.3 --psy-rd 0.4 --qblur 0.6 --qcomp 0.8 --vbv-init 0.4 --aq-mode 3 --b-adapt 0 --bframes 16 --crf 0 --keyint 270 --lookahead-threads 1 --min-keyint 22 --qp 20 --qpstep 3 --qpmin 1 --qpmax 67 --rc-lookahead 48 --ref 3 --vbv-bufsize 1000 --deblock 1:1 --me umh --overscan show --preset slow --scenecut 30 --tune grain --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
