...
{ time x264  --aud --slow-firstpass --no-weightb --aq-strength 2.0 --ipratio 1.6 --pbratio 1.0 --psy-rd 4.2 --qblur 0.4 --qcomp 0.6 --vbv-init 0.1 --aq-mode 1 --b-adapt 2 --bframes 14 --crf 25 --keyint 290 --lookahead-threads 0 --min-keyint 28 --qp 10 --qpstep 3 --qpmin 1 --qpmax 67 --rc-lookahead 48 --ref 4 --vbv-bufsize 1000 --deblock -1:-1 --me hex --overscan crop --preset veryslow --scenecut 30 --tune grain --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
