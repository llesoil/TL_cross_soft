...
{ time x264  --constrained-intra --no-asm --no-weightb --aq-strength 3.0 --ipratio 1.0 --pbratio 1.2 --psy-rd 0.8 --qblur 0.6 --qcomp 0.6 --vbv-init 0.4 --aq-mode 0 --b-adapt 2 --bframes 16 --crf 10 --keyint 290 --lookahead-threads 0 --min-keyint 29 --qp 50 --qpstep 3 --qpmin 3 --qpmax 69 --rc-lookahead 18 --ref 3 --vbv-bufsize 1000 --deblock -1:-1 --me dia --overscan show --preset slow --scenecut 40 --tune psnr --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
