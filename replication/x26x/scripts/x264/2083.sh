...
{ time x264  --weightb --aq-strength 2.5 --ipratio 1.0 --pbratio 1.3 --psy-rd 2.2 --qblur 0.2 --qcomp 0.8 --vbv-init 0.5 --aq-mode 1 --b-adapt 0 --bframes 10 --crf 5 --keyint 250 --lookahead-threads 0 --min-keyint 22 --qp 0 --qpstep 4 --qpmin 2 --qpmax 60 --rc-lookahead 38 --ref 1 --vbv-bufsize 1000 --deblock -2:-2 --me dia --overscan show --preset placebo --scenecut 10 --tune ssim --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
