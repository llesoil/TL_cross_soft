...
{ time x264  --aud --constrained-intra --no-asm --weightb --aq-strength 2.0 --ipratio 1.2 --pbratio 1.0 --psy-rd 1.8 --qblur 0.6 --qcomp 0.9 --vbv-init 0.9 --aq-mode 1 --b-adapt 1 --bframes 2 --crf 15 --keyint 270 --lookahead-threads 1 --min-keyint 22 --qp 50 --qpstep 3 --qpmin 3 --qpmax 65 --rc-lookahead 28 --ref 3 --vbv-bufsize 2000 --deblock -2:-2 --me umh --overscan crop --preset fast --scenecut 40 --tune ssim --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
