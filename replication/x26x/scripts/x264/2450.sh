...
{ time x264  --aud --constrained-intra --no-asm --weightb --aq-strength 1.5 --ipratio 1.5 --pbratio 1.4 --psy-rd 0.8 --qblur 0.3 --qcomp 0.6 --vbv-init 0.5 --aq-mode 1 --b-adapt 0 --bframes 10 --crf 5 --keyint 250 --lookahead-threads 4 --min-keyint 24 --qp 10 --qpstep 5 --qpmin 0 --qpmax 66 --rc-lookahead 28 --ref 4 --vbv-bufsize 2000 --deblock 1:1 --me umh --overscan crop --preset medium --scenecut 10 --tune ssim --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
