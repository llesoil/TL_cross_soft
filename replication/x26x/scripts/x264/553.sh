...
{ time x264  --no-weightb --aq-strength 1.0 --ipratio 1.5 --pbratio 1.0 --psy-rd 1.0 --qblur 0.6 --qcomp 0.9 --vbv-init 0.8 --aq-mode 0 --b-adapt 1 --bframes 0 --crf 20 --keyint 270 --lookahead-threads 1 --min-keyint 26 --qp 50 --qpstep 3 --qpmin 1 --qpmax 63 --rc-lookahead 28 --ref 3 --vbv-bufsize 2000 --deblock -2:-2 --me dia --overscan show --preset faster --scenecut 0 --tune ssim --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
