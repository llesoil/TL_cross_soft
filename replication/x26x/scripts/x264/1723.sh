...
{ time x264  --slow-firstpass --no-weightb --aq-strength 2.5 --ipratio 1.4 --pbratio 1.0 --psy-rd 2.6 --qblur 0.6 --qcomp 0.6 --vbv-init 0.4 --aq-mode 3 --b-adapt 0 --bframes 10 --crf 40 --keyint 260 --lookahead-threads 1 --min-keyint 23 --qp 50 --qpstep 5 --qpmin 4 --qpmax 64 --rc-lookahead 28 --ref 2 --vbv-bufsize 1000 --deblock 1:1 --me dia --overscan show --preset slower --scenecut 40 --tune grain --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
