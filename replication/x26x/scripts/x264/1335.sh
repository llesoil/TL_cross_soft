...
{ time x264  --constrained-intra --weightb --aq-strength 3.0 --ipratio 1.6 --pbratio 1.1 --psy-rd 4.8 --qblur 0.4 --qcomp 0.9 --vbv-init 0.6 --aq-mode 2 --b-adapt 1 --bframes 10 --crf 10 --keyint 290 --lookahead-threads 1 --min-keyint 21 --qp 50 --qpstep 4 --qpmin 3 --qpmax 68 --rc-lookahead 48 --ref 4 --vbv-bufsize 2000 --deblock 1:1 --me dia --overscan crop --preset veryfast --scenecut 10 --tune psnr --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
