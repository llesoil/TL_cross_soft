...
{ time x264  --no-asm --weightb --aq-strength 1.0 --ipratio 1.2 --pbratio 1.4 --psy-rd 0.4 --qblur 0.2 --qcomp 0.6 --vbv-init 0.3 --aq-mode 3 --b-adapt 0 --bframes 12 --crf 50 --keyint 250 --lookahead-threads 0 --min-keyint 28 --qp 20 --qpstep 3 --qpmin 0 --qpmax 60 --rc-lookahead 38 --ref 5 --vbv-bufsize 2000 --deblock -1:-1 --me umh --overscan crop --preset veryslow --scenecut 0 --tune animation --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
