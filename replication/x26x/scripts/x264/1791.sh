...
{ time x264  --no-asm --no-weightb --aq-strength 2.5 --ipratio 1.4 --pbratio 1.2 --psy-rd 4.8 --qblur 0.4 --qcomp 0.8 --vbv-init 0.3 --aq-mode 2 --b-adapt 1 --bframes 4 --crf 25 --keyint 250 --lookahead-threads 1 --min-keyint 29 --qp 30 --qpstep 4 --qpmin 0 --qpmax 69 --rc-lookahead 38 --ref 4 --vbv-bufsize 1000 --deblock 1:1 --me hex --overscan show --preset slower --scenecut 0 --tune animation --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
