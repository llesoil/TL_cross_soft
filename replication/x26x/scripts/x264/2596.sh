...
{ time x264  --constrained-intra --weightb --aq-strength 1.5 --ipratio 1.3 --pbratio 1.0 --psy-rd 3.4 --qblur 0.3 --qcomp 0.9 --vbv-init 0.3 --aq-mode 1 --b-adapt 2 --bframes 4 --crf 35 --keyint 280 --lookahead-threads 4 --min-keyint 28 --qp 50 --qpstep 3 --qpmin 2 --qpmax 60 --rc-lookahead 28 --ref 3 --vbv-bufsize 2000 --deblock -2:-2 --me dia --overscan crop --preset medium --scenecut 10 --tune grain --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
