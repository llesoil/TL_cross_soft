...
{ time x264  --no-weightb --aq-strength 1.0 --ipratio 1.6 --pbratio 1.1 --psy-rd 1.0 --qblur 0.3 --qcomp 0.6 --vbv-init 0.6 --aq-mode 2 --b-adapt 2 --bframes 2 --crf 15 --keyint 200 --lookahead-threads 1 --min-keyint 30 --qp 30 --qpstep 5 --qpmin 1 --qpmax 67 --rc-lookahead 18 --ref 3 --vbv-bufsize 1000 --deblock -1:-1 --me dia --overscan crop --preset medium --scenecut 0 --tune psnr --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
