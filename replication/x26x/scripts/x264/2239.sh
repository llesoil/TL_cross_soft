...
{ time x264  --constrained-intra --intra-refresh --no-asm --no-weightb --aq-strength 0.0 --ipratio 1.1 --pbratio 1.2 --psy-rd 4.0 --qblur 0.3 --qcomp 0.6 --vbv-init 0.8 --aq-mode 3 --b-adapt 0 --bframes 6 --crf 20 --keyint 270 --lookahead-threads 0 --min-keyint 25 --qp 50 --qpstep 4 --qpmin 0 --qpmax 61 --rc-lookahead 18 --ref 1 --vbv-bufsize 2000 --deblock -1:-1 --me umh --overscan show --preset slower --scenecut 0 --tune grain --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
