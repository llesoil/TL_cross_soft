...
{ time x264  --slow-firstpass --no-weightb --aq-strength 1.5 --ipratio 1.1 --pbratio 1.0 --psy-rd 3.0 --qblur 0.3 --qcomp 0.9 --vbv-init 0.6 --aq-mode 0 --b-adapt 1 --bframes 6 --crf 50 --keyint 270 --lookahead-threads 4 --min-keyint 28 --qp 30 --qpstep 5 --qpmin 2 --qpmax 62 --rc-lookahead 18 --ref 4 --vbv-bufsize 2000 --deblock 1:1 --me hex --overscan show --preset faster --scenecut 0 --tune grain --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
