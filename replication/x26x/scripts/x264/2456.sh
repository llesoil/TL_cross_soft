...
{ time x264  --aud --constrained-intra --slow-firstpass --no-weightb --aq-strength 2.0 --ipratio 1.6 --pbratio 1.3 --psy-rd 2.2 --qblur 0.2 --qcomp 0.6 --vbv-init 0.1 --aq-mode 0 --b-adapt 1 --bframes 16 --crf 40 --keyint 210 --lookahead-threads 3 --min-keyint 24 --qp 50 --qpstep 4 --qpmin 0 --qpmax 63 --rc-lookahead 48 --ref 3 --vbv-bufsize 2000 --deblock 1:1 --me hex --overscan crop --preset fast --scenecut 40 --tune ssim --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
