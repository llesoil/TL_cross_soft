...
{ time x264  --constrained-intra --weightb --aq-strength 3.0 --ipratio 1.1 --pbratio 1.1 --psy-rd 0.8 --qblur 0.5 --qcomp 0.9 --vbv-init 0.1 --aq-mode 1 --b-adapt 0 --bframes 16 --crf 10 --keyint 200 --lookahead-threads 1 --min-keyint 23 --qp 0 --qpstep 4 --qpmin 4 --qpmax 60 --rc-lookahead 18 --ref 3 --vbv-bufsize 2000 --deblock -2:-2 --me umh --overscan crop --preset ultrafast --scenecut 10 --tune psnr --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
