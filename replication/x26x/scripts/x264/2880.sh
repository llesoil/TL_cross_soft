...
{ time x264  --constrained-intra --no-weightb --aq-strength 2.5 --ipratio 1.5 --pbratio 1.4 --psy-rd 0.4 --qblur 0.4 --qcomp 0.8 --vbv-init 0.9 --aq-mode 1 --b-adapt 0 --bframes 2 --crf 40 --keyint 300 --lookahead-threads 1 --min-keyint 25 --qp 30 --qpstep 4 --qpmin 3 --qpmax 60 --rc-lookahead 28 --ref 6 --vbv-bufsize 2000 --deblock -1:-1 --me umh --overscan show --preset superfast --scenecut 30 --tune animation --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
