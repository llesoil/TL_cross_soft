...
{ time x264  --aud --constrained-intra --slow-firstpass --no-weightb --aq-strength 2.0 --ipratio 1.0 --pbratio 1.3 --psy-rd 1.6 --qblur 0.2 --qcomp 0.8 --vbv-init 0.2 --aq-mode 3 --b-adapt 0 --bframes 6 --crf 5 --keyint 300 --lookahead-threads 1 --min-keyint 21 --qp 20 --qpstep 3 --qpmin 1 --qpmax 67 --rc-lookahead 18 --ref 1 --vbv-bufsize 1000 --deblock -2:-2 --me umh --overscan crop --preset faster --scenecut 30 --tune grain --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
