...
{ time x264  --aud --no-asm --weightb --aq-strength 1.5 --ipratio 1.5 --pbratio 1.0 --psy-rd 0.4 --qblur 0.3 --qcomp 0.9 --vbv-init 0.6 --aq-mode 2 --b-adapt 2 --bframes 16 --crf 0 --keyint 270 --lookahead-threads 4 --min-keyint 21 --qp 40 --qpstep 4 --qpmin 1 --qpmax 66 --rc-lookahead 28 --ref 5 --vbv-bufsize 1000 --deblock 1:1 --me dia --overscan show --preset fast --scenecut 30 --tune ssim --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
