...
{ time x264  --no-asm --slow-firstpass --no-weightb --aq-strength 3.0 --ipratio 1.3 --pbratio 1.2 --psy-rd 5.0 --qblur 0.3 --qcomp 0.9 --vbv-init 0.4 --aq-mode 3 --b-adapt 1 --bframes 14 --crf 20 --keyint 280 --lookahead-threads 0 --min-keyint 29 --qp 50 --qpstep 4 --qpmin 1 --qpmax 64 --rc-lookahead 48 --ref 5 --vbv-bufsize 2000 --deblock -2:-2 --me hex --overscan show --preset superfast --scenecut 0 --tune grain --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
