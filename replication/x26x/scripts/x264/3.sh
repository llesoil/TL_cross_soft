...
{ time x264  --aud --constrained-intra --no-asm --weightb --aq-strength 3.0 --ipratio 1.3 --pbratio 1.1 --psy-rd 3.4 --qblur 0.6 --qcomp 0.9 --vbv-init 0.2 --aq-mode 2 --b-adapt 0 --bframes 2 --crf 0 --keyint 260 --lookahead-threads 2 --min-keyint 20 --qp 10 --qpstep 3 --qpmin 4 --qpmax 68 --rc-lookahead 48 --ref 5 --vbv-bufsize 1000 --deblock 1:1 --me dia --overscan crop --preset slow --scenecut 10 --tune grain --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
