...
{ time x264  --weightb --aq-strength 0.0 --ipratio 1.6 --pbratio 1.3 --psy-rd 2.4 --qblur 0.2 --qcomp 0.6 --vbv-init 0.0 --aq-mode 2 --b-adapt 1 --bframes 16 --crf 5 --keyint 220 --lookahead-threads 1 --min-keyint 27 --qp 10 --qpstep 3 --qpmin 1 --qpmax 65 --rc-lookahead 18 --ref 2 --vbv-bufsize 1000 --deblock -1:-1 --me dia --overscan crop --preset fast --scenecut 30 --tune ssim --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
