...
{ time x264  --aud --constrained-intra --slow-firstpass --no-weightb --aq-strength 1.5 --ipratio 1.1 --pbratio 1.4 --psy-rd 1.2 --qblur 0.5 --qcomp 0.8 --vbv-init 0.3 --aq-mode 1 --b-adapt 1 --bframes 14 --crf 40 --keyint 250 --lookahead-threads 1 --min-keyint 23 --qp 40 --qpstep 4 --qpmin 1 --qpmax 61 --rc-lookahead 28 --ref 5 --vbv-bufsize 2000 --deblock -1:-1 --me dia --overscan show --preset veryfast --scenecut 40 --tune animation --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
