...
{ time x264  --aud --no-asm --slow-firstpass --no-weightb --aq-strength 1.5 --ipratio 1.6 --pbratio 1.1 --psy-rd 2.2 --qblur 0.2 --qcomp 0.6 --vbv-init 0.6 --aq-mode 3 --b-adapt 0 --bframes 10 --crf 40 --keyint 260 --lookahead-threads 0 --min-keyint 20 --qp 30 --qpstep 3 --qpmin 4 --qpmax 61 --rc-lookahead 38 --ref 2 --vbv-bufsize 1000 --deblock 1:1 --me dia --overscan show --preset superfast --scenecut 10 --tune psnr --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
