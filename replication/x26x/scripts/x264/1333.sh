...
{ time x264  --aud --no-asm --no-weightb --aq-strength 1.0 --ipratio 1.4 --pbratio 1.4 --psy-rd 2.2 --qblur 0.5 --qcomp 0.6 --vbv-init 0.2 --aq-mode 3 --b-adapt 1 --bframes 10 --crf 25 --keyint 280 --lookahead-threads 1 --min-keyint 25 --qp 30 --qpstep 4 --qpmin 2 --qpmax 69 --rc-lookahead 38 --ref 5 --vbv-bufsize 2000 --deblock 1:1 --me hex --overscan crop --preset slow --scenecut 0 --tune psnr --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
