...
{ time x264  --aud --constrained-intra --no-asm --weightb --aq-strength 1.5 --ipratio 1.0 --pbratio 1.0 --psy-rd 1.8 --qblur 0.2 --qcomp 0.8 --vbv-init 0.0 --aq-mode 2 --b-adapt 1 --bframes 8 --crf 45 --keyint 220 --lookahead-threads 4 --min-keyint 20 --qp 50 --qpstep 3 --qpmin 1 --qpmax 63 --rc-lookahead 48 --ref 1 --vbv-bufsize 2000 --deblock -1:-1 --me umh --overscan show --preset fast --scenecut 30 --tune psnr --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
