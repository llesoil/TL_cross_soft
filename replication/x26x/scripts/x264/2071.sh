...
{ time x264  --constrained-intra --no-asm --weightb --aq-strength 0.5 --ipratio 1.3 --pbratio 1.0 --psy-rd 2.8 --qblur 0.3 --qcomp 0.9 --vbv-init 0.1 --aq-mode 2 --b-adapt 1 --bframes 8 --crf 15 --keyint 300 --lookahead-threads 4 --min-keyint 24 --qp 30 --qpstep 5 --qpmin 1 --qpmax 69 --rc-lookahead 38 --ref 3 --vbv-bufsize 1000 --deblock 1:1 --me hex --overscan crop --preset medium --scenecut 0 --tune psnr --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
