...
{ time x264  --constrained-intra --weightb --aq-strength 1.5 --ipratio 1.1 --pbratio 1.2 --psy-rd 0.8 --qblur 0.3 --qcomp 0.8 --vbv-init 0.8 --aq-mode 1 --b-adapt 2 --bframes 4 --crf 40 --keyint 250 --lookahead-threads 4 --min-keyint 27 --qp 10 --qpstep 5 --qpmin 1 --qpmax 67 --rc-lookahead 48 --ref 5 --vbv-bufsize 2000 --deblock -2:-2 --me hex --overscan show --preset veryslow --scenecut 30 --tune ssim --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
