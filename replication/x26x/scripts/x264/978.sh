...
{ time x264  --aud --constrained-intra --no-asm --no-weightb --aq-strength 1.0 --ipratio 1.1 --pbratio 1.1 --psy-rd 2.0 --qblur 0.5 --qcomp 0.6 --vbv-init 0.9 --aq-mode 2 --b-adapt 1 --bframes 6 --crf 50 --keyint 250 --lookahead-threads 2 --min-keyint 21 --qp 50 --qpstep 3 --qpmin 2 --qpmax 62 --rc-lookahead 38 --ref 2 --vbv-bufsize 2000 --deblock -1:-1 --me umh --overscan crop --preset fast --scenecut 30 --tune animation --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
