...
{ time x264  --slow-firstpass --no-weightb --aq-strength 0.5 --ipratio 1.0 --pbratio 1.1 --psy-rd 3.2 --qblur 0.3 --qcomp 0.8 --vbv-init 0.9 --aq-mode 3 --b-adapt 2 --bframes 0 --crf 20 --keyint 290 --lookahead-threads 1 --min-keyint 28 --qp 50 --qpstep 4 --qpmin 2 --qpmax 69 --rc-lookahead 18 --ref 5 --vbv-bufsize 1000 --deblock -2:-2 --me dia --overscan show --preset veryfast --scenecut 40 --tune animation --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
