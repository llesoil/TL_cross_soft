...
{ time x264  --no-asm --weightb --aq-strength 3.0 --ipratio 1.4 --pbratio 1.0 --psy-rd 0.4 --qblur 0.2 --qcomp 0.8 --vbv-init 0.5 --aq-mode 2 --b-adapt 0 --bframes 12 --crf 40 --keyint 290 --lookahead-threads 1 --min-keyint 27 --qp 30 --qpstep 4 --qpmin 0 --qpmax 61 --rc-lookahead 28 --ref 1 --vbv-bufsize 2000 --deblock 1:1 --me hex --overscan crop --preset superfast --scenecut 10 --tune ssim --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
