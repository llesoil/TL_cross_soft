...
{ time x264  --aud --constrained-intra --intra-refresh --slow-firstpass --no-weightb --aq-strength 1.0 --ipratio 1.4 --pbratio 1.0 --psy-rd 4.4 --qblur 0.4 --qcomp 0.8 --vbv-init 0.6 --aq-mode 3 --b-adapt 1 --bframes 16 --crf 25 --keyint 290 --lookahead-threads 3 --min-keyint 26 --qp 20 --qpstep 3 --qpmin 1 --qpmax 60 --rc-lookahead 28 --ref 1 --vbv-bufsize 2000 --deblock 1:1 --me umh --overscan crop --preset fast --scenecut 0 --tune ssim --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
