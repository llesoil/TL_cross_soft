...
{ time x264  --aud --constrained-intra --no-asm --weightb --aq-strength 1.0 --ipratio 1.6 --pbratio 1.3 --psy-rd 0.8 --qblur 0.4 --qcomp 0.9 --vbv-init 0.0 --aq-mode 0 --b-adapt 1 --bframes 16 --crf 35 --keyint 250 --lookahead-threads 3 --min-keyint 24 --qp 30 --qpstep 3 --qpmin 2 --qpmax 63 --rc-lookahead 28 --ref 4 --vbv-bufsize 2000 --deblock -2:-2 --me hex --overscan show --preset slower --scenecut 10 --tune grain --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
