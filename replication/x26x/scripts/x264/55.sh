...
{ time x264  --constrained-intra --no-asm --slow-firstpass --no-weightb --aq-strength 0.5 --ipratio 1.3 --pbratio 1.1 --psy-rd 4.2 --qblur 0.2 --qcomp 0.6 --vbv-init 0.3 --aq-mode 2 --b-adapt 1 --bframes 16 --crf 20 --keyint 210 --lookahead-threads 2 --min-keyint 23 --qp 30 --qpstep 4 --qpmin 1 --qpmax 67 --rc-lookahead 48 --ref 5 --vbv-bufsize 1000 --deblock -1:-1 --me dia --overscan crop --preset fast --scenecut 10 --tune psnr --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
