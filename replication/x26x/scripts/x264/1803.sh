...
{ time x264  --aud --no-asm --weightb --aq-strength 2.5 --ipratio 1.3 --pbratio 1.0 --psy-rd 5.0 --qblur 0.3 --qcomp 0.6 --vbv-init 0.5 --aq-mode 2 --b-adapt 1 --bframes 14 --crf 50 --keyint 250 --lookahead-threads 4 --min-keyint 30 --qp 10 --qpstep 4 --qpmin 1 --qpmax 63 --rc-lookahead 48 --ref 3 --vbv-bufsize 1000 --deblock -2:-2 --me dia --overscan crop --preset medium --scenecut 40 --tune psnr --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
