...
{ time x264  --aud --constrained-intra --no-weightb --aq-strength 2.5 --ipratio 1.1 --pbratio 1.4 --psy-rd 0.4 --qblur 0.6 --qcomp 0.6 --vbv-init 0.6 --aq-mode 3 --b-adapt 2 --bframes 6 --crf 40 --keyint 260 --lookahead-threads 4 --min-keyint 24 --qp 20 --qpstep 3 --qpmin 3 --qpmax 66 --rc-lookahead 48 --ref 2 --vbv-bufsize 2000 --deblock -1:-1 --me dia --overscan show --preset faster --scenecut 0 --tune animation --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
