...
{ time x264  --no-asm --slow-firstpass --no-weightb --aq-strength 1.5 --ipratio 1.0 --pbratio 1.0 --psy-rd 0.2 --qblur 0.3 --qcomp 0.6 --vbv-init 0.5 --aq-mode 0 --b-adapt 1 --bframes 6 --crf 35 --keyint 290 --lookahead-threads 1 --min-keyint 25 --qp 50 --qpstep 5 --qpmin 3 --qpmax 62 --rc-lookahead 48 --ref 6 --vbv-bufsize 2000 --deblock -2:-2 --me dia --overscan crop --preset veryfast --scenecut 40 --tune grain --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
