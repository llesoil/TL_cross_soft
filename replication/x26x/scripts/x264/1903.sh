...
{ time x264  --weightb --aq-strength 1.0 --ipratio 1.0 --pbratio 1.2 --psy-rd 0.2 --qblur 0.4 --qcomp 0.9 --vbv-init 0.9 --aq-mode 0 --b-adapt 1 --bframes 12 --crf 35 --keyint 290 --lookahead-threads 4 --min-keyint 24 --qp 50 --qpstep 3 --qpmin 1 --qpmax 68 --rc-lookahead 18 --ref 5 --vbv-bufsize 2000 --deblock -2:-2 --me dia --overscan crop --preset placebo --scenecut 10 --tune animation --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
