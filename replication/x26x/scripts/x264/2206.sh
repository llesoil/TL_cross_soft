...
{ time x264  --no-asm --weightb --aq-strength 1.5 --ipratio 1.5 --pbratio 1.2 --psy-rd 0.8 --qblur 0.6 --qcomp 0.6 --vbv-init 0.6 --aq-mode 1 --b-adapt 2 --bframes 12 --crf 5 --keyint 270 --lookahead-threads 4 --min-keyint 22 --qp 20 --qpstep 5 --qpmin 1 --qpmax 64 --rc-lookahead 18 --ref 3 --vbv-bufsize 2000 --deblock 1:1 --me hex --overscan crop --preset veryfast --scenecut 40 --tune animation --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
