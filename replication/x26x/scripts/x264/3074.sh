...
{ time x264  --aud --constrained-intra --no-asm --weightb --aq-strength 3.0 --ipratio 1.5 --pbratio 1.1 --psy-rd 2.2 --qblur 0.3 --qcomp 0.8 --vbv-init 0.3 --aq-mode 0 --b-adapt 1 --bframes 4 --crf 0 --keyint 270 --lookahead-threads 4 --min-keyint 23 --qp 40 --qpstep 5 --qpmin 1 --qpmax 63 --rc-lookahead 48 --ref 3 --vbv-bufsize 2000 --deblock 1:1 --me umh --overscan crop --preset fast --scenecut 10 --tune psnr --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
