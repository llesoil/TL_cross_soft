...
{ time x264  --aud --constrained-intra --no-asm --weightb --aq-strength 3.0 --ipratio 1.6 --pbratio 1.0 --psy-rd 2.0 --qblur 0.6 --qcomp 0.6 --vbv-init 0.8 --aq-mode 2 --b-adapt 0 --bframes 14 --crf 40 --keyint 220 --lookahead-threads 4 --min-keyint 25 --qp 30 --qpstep 5 --qpmin 1 --qpmax 61 --rc-lookahead 28 --ref 6 --vbv-bufsize 2000 --deblock -1:-1 --me dia --overscan show --preset medium --scenecut 30 --tune animation --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
