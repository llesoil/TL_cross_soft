...
{ time x264  --constrained-intra --slow-firstpass --no-weightb --aq-strength 1.0 --ipratio 1.5 --pbratio 1.0 --psy-rd 0.8 --qblur 0.6 --qcomp 0.6 --vbv-init 0.1 --aq-mode 2 --b-adapt 0 --bframes 2 --crf 10 --keyint 270 --lookahead-threads 4 --min-keyint 30 --qp 20 --qpstep 4 --qpmin 1 --qpmax 64 --rc-lookahead 18 --ref 5 --vbv-bufsize 1000 --deblock -1:-1 --me umh --overscan show --preset superfast --scenecut 0 --tune animation --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
