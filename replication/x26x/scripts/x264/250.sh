...
{ time x264  --aud --slow-firstpass --no-weightb --aq-strength 3.0 --ipratio 1.2 --pbratio 1.4 --psy-rd 3.2 --qblur 0.6 --qcomp 0.9 --vbv-init 0.1 --aq-mode 2 --b-adapt 1 --bframes 4 --crf 25 --keyint 280 --lookahead-threads 2 --min-keyint 27 --qp 40 --qpstep 5 --qpmin 3 --qpmax 60 --rc-lookahead 38 --ref 3 --vbv-bufsize 1000 --deblock -1:-1 --me hex --overscan crop --preset ultrafast --scenecut 30 --tune animation --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
