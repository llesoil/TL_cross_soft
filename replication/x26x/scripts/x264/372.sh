...
{ time x264  --no-weightb --aq-strength 1.0 --ipratio 1.5 --pbratio 1.1 --psy-rd 2.2 --qblur 0.2 --qcomp 0.6 --vbv-init 0.8 --aq-mode 1 --b-adapt 2 --bframes 2 --crf 0 --keyint 200 --lookahead-threads 1 --min-keyint 30 --qp 50 --qpstep 4 --qpmin 1 --qpmax 68 --rc-lookahead 18 --ref 5 --vbv-bufsize 2000 --deblock -1:-1 --me hex --overscan show --preset veryfast --scenecut 0 --tune ssim --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
