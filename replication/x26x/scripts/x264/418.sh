...
{ time x264  --aud --no-asm --weightb --aq-strength 2.0 --ipratio 1.0 --pbratio 1.1 --psy-rd 1.6 --qblur 0.4 --qcomp 0.9 --vbv-init 0.5 --aq-mode 2 --b-adapt 0 --bframes 8 --crf 35 --keyint 250 --lookahead-threads 4 --min-keyint 24 --qp 40 --qpstep 5 --qpmin 2 --qpmax 64 --rc-lookahead 28 --ref 4 --vbv-bufsize 2000 --deblock -2:-2 --me dia --overscan show --preset medium --scenecut 0 --tune psnr --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
