...
{ time x264  --no-asm --slow-firstpass --no-weightb --aq-strength 2.5 --ipratio 1.6 --pbratio 1.4 --psy-rd 5.0 --qblur 0.4 --qcomp 0.9 --vbv-init 0.5 --aq-mode 1 --b-adapt 0 --bframes 16 --crf 20 --keyint 280 --lookahead-threads 1 --min-keyint 23 --qp 0 --qpstep 3 --qpmin 1 --qpmax 66 --rc-lookahead 38 --ref 4 --vbv-bufsize 2000 --deblock -1:-1 --me dia --overscan show --preset slow --scenecut 40 --tune ssim --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
