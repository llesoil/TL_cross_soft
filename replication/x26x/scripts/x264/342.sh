...
{ time x264  --aud --constrained-intra --no-asm --no-weightb --aq-strength 2.5 --ipratio 1.3 --pbratio 1.1 --psy-rd 4.8 --qblur 0.5 --qcomp 0.9 --vbv-init 0.9 --aq-mode 1 --b-adapt 0 --bframes 4 --crf 50 --keyint 260 --lookahead-threads 4 --min-keyint 22 --qp 50 --qpstep 3 --qpmin 3 --qpmax 65 --rc-lookahead 48 --ref 3 --vbv-bufsize 1000 --deblock -1:-1 --me umh --overscan crop --preset slow --scenecut 10 --tune psnr --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
