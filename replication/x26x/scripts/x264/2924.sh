...
{ time x264  --no-asm --slow-firstpass --no-weightb --aq-strength 2.5 --ipratio 1.0 --pbratio 1.0 --psy-rd 2.4 --qblur 0.4 --qcomp 0.6 --vbv-init 0.9 --aq-mode 2 --b-adapt 0 --bframes 8 --crf 15 --keyint 300 --lookahead-threads 4 --min-keyint 30 --qp 0 --qpstep 4 --qpmin 1 --qpmax 68 --rc-lookahead 38 --ref 4 --vbv-bufsize 1000 --deblock -2:-2 --me hex --overscan crop --preset slow --scenecut 10 --tune psnr --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
