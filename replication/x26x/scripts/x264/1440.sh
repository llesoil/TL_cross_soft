...
{ time x264  --constrained-intra --no-asm --no-weightb --aq-strength 3.0 --ipratio 1.1 --pbratio 1.4 --psy-rd 0.4 --qblur 0.4 --qcomp 0.8 --vbv-init 0.4 --aq-mode 1 --b-adapt 2 --bframes 12 --crf 35 --keyint 270 --lookahead-threads 4 --min-keyint 30 --qp 30 --qpstep 5 --qpmin 3 --qpmax 66 --rc-lookahead 18 --ref 2 --vbv-bufsize 1000 --deblock -1:-1 --me hex --overscan crop --preset fast --scenecut 30 --tune grain --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
