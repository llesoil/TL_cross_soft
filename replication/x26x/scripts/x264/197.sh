...
{ time x264  --aud --constrained-intra --no-asm --no-weightb --aq-strength 2.5 --ipratio 1.5 --pbratio 1.4 --psy-rd 1.8 --qblur 0.5 --qcomp 0.8 --vbv-init 0.0 --aq-mode 2 --b-adapt 1 --bframes 10 --crf 40 --keyint 220 --lookahead-threads 2 --min-keyint 30 --qp 30 --qpstep 4 --qpmin 3 --qpmax 62 --rc-lookahead 38 --ref 5 --vbv-bufsize 1000 --deblock 1:1 --me hex --overscan show --preset slow --scenecut 0 --tune animation --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
