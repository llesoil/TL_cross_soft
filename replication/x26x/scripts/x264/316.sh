...
{ time x264  --aud --constrained-intra --no-weightb --aq-strength 2.0 --ipratio 1.5 --pbratio 1.0 --psy-rd 2.6 --qblur 0.4 --qcomp 0.9 --vbv-init 0.9 --aq-mode 1 --b-adapt 1 --bframes 6 --crf 20 --keyint 200 --lookahead-threads 1 --min-keyint 27 --qp 50 --qpstep 3 --qpmin 4 --qpmax 67 --rc-lookahead 28 --ref 2 --vbv-bufsize 1000 --deblock -2:-2 --me dia --overscan crop --preset superfast --scenecut 40 --tune ssim --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
