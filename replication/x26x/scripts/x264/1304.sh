...
{ time x264  --aud --no-asm --no-weightb --aq-strength 1.0 --ipratio 1.0 --pbratio 1.0 --psy-rd 3.0 --qblur 0.2 --qcomp 0.9 --vbv-init 0.3 --aq-mode 3 --b-adapt 1 --bframes 14 --crf 35 --keyint 200 --lookahead-threads 1 --min-keyint 22 --qp 50 --qpstep 4 --qpmin 0 --qpmax 62 --rc-lookahead 18 --ref 4 --vbv-bufsize 1000 --deblock -1:-1 --me umh --overscan crop --preset medium --scenecut 40 --tune animation --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
