...
{ time x264  --constrained-intra --no-asm --weightb --aq-strength 2.5 --ipratio 1.1 --pbratio 1.4 --psy-rd 4.8 --qblur 0.2 --qcomp 0.6 --vbv-init 0.2 --aq-mode 1 --b-adapt 0 --bframes 10 --crf 10 --keyint 260 --lookahead-threads 2 --min-keyint 29 --qp 0 --qpstep 3 --qpmin 1 --qpmax 63 --rc-lookahead 18 --ref 2 --vbv-bufsize 1000 --deblock -2:-2 --me hex --overscan crop --preset placebo --scenecut 10 --tune grain --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
