...
{ time x264  --constrained-intra --weightb --aq-strength 2.5 --ipratio 1.2 --pbratio 1.3 --psy-rd 3.2 --qblur 0.5 --qcomp 0.9 --vbv-init 0.6 --aq-mode 2 --b-adapt 0 --bframes 16 --crf 40 --keyint 260 --lookahead-threads 4 --min-keyint 23 --qp 30 --qpstep 4 --qpmin 3 --qpmax 65 --rc-lookahead 48 --ref 4 --vbv-bufsize 1000 --deblock -1:-1 --me umh --overscan show --preset veryslow --scenecut 0 --tune psnr --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
