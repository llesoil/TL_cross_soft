...
{ time x264  --constrained-intra --no-asm --no-weightb --aq-strength 3.0 --ipratio 1.2 --pbratio 1.2 --psy-rd 1.2 --qblur 0.2 --qcomp 0.9 --vbv-init 0.2 --aq-mode 1 --b-adapt 0 --bframes 0 --crf 5 --keyint 270 --lookahead-threads 2 --min-keyint 30 --qp 10 --qpstep 4 --qpmin 1 --qpmax 67 --rc-lookahead 38 --ref 6 --vbv-bufsize 1000 --deblock -1:-1 --me dia --overscan crop --preset slow --scenecut 30 --tune grain --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
