...
{ time x264  --aud --no-asm --no-weightb --aq-strength 1.5 --ipratio 1.4 --pbratio 1.0 --psy-rd 0.8 --qblur 0.2 --qcomp 0.8 --vbv-init 0.6 --aq-mode 2 --b-adapt 0 --bframes 8 --crf 15 --keyint 300 --lookahead-threads 0 --min-keyint 27 --qp 0 --qpstep 4 --qpmin 1 --qpmax 60 --rc-lookahead 18 --ref 2 --vbv-bufsize 1000 --deblock -2:-2 --me umh --overscan crop --preset slow --scenecut 40 --tune ssim --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
