...
{ time x264  --weightb --aq-strength 3.0 --ipratio 1.6 --pbratio 1.0 --psy-rd 2.8 --qblur 0.3 --qcomp 0.8 --vbv-init 0.9 --aq-mode 1 --b-adapt 2 --bframes 16 --crf 50 --keyint 300 --lookahead-threads 1 --min-keyint 30 --qp 30 --qpstep 4 --qpmin 3 --qpmax 63 --rc-lookahead 48 --ref 3 --vbv-bufsize 2000 --deblock -2:-2 --me dia --overscan crop --preset faster --scenecut 30 --tune animation --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
