...
{ time x264  --aud --no-asm --no-weightb --aq-strength 0.5 --ipratio 1.0 --pbratio 1.3 --psy-rd 4.8 --qblur 0.6 --qcomp 0.9 --vbv-init 0.5 --aq-mode 1 --b-adapt 2 --bframes 16 --crf 20 --keyint 250 --lookahead-threads 1 --min-keyint 20 --qp 50 --qpstep 3 --qpmin 2 --qpmax 62 --rc-lookahead 48 --ref 1 --vbv-bufsize 1000 --deblock 1:1 --me dia --overscan crop --preset veryfast --scenecut 10 --tune psnr --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
