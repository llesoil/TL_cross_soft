...
{ time x264  --weightb --aq-strength 0.5 --ipratio 1.5 --pbratio 1.0 --psy-rd 4.2 --qblur 0.2 --qcomp 0.8 --vbv-init 0.4 --aq-mode 1 --b-adapt 0 --bframes 2 --crf 0 --keyint 200 --lookahead-threads 4 --min-keyint 20 --qp 20 --qpstep 3 --qpmin 1 --qpmax 63 --rc-lookahead 18 --ref 5 --vbv-bufsize 2000 --deblock 1:1 --me dia --overscan show --preset fast --scenecut 40 --tune animation --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
