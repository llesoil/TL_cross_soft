...
{ time x264  --constrained-intra --weightb --aq-strength 3.0 --ipratio 1.4 --pbratio 1.4 --psy-rd 2.6 --qblur 0.6 --qcomp 0.9 --vbv-init 0.8 --aq-mode 1 --b-adapt 2 --bframes 0 --crf 5 --keyint 290 --lookahead-threads 2 --min-keyint 28 --qp 50 --qpstep 3 --qpmin 1 --qpmax 60 --rc-lookahead 48 --ref 2 --vbv-bufsize 1000 --deblock -1:-1 --me hex --overscan crop --preset veryslow --scenecut 30 --tune psnr --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
