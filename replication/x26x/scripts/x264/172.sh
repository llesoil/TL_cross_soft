...
{ time x264  --aud --weightb --aq-strength 2.5 --ipratio 1.4 --pbratio 1.2 --psy-rd 4.6 --qblur 0.3 --qcomp 0.9 --vbv-init 0.5 --aq-mode 2 --b-adapt 2 --bframes 14 --crf 50 --keyint 300 --lookahead-threads 2 --min-keyint 24 --qp 50 --qpstep 4 --qpmin 2 --qpmax 67 --rc-lookahead 18 --ref 4 --vbv-bufsize 1000 --deblock -1:-1 --me dia --overscan crop --preset ultrafast --scenecut 0 --tune grain --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
