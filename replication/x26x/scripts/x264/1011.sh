...
{ time x264  --aud --no-weightb --aq-strength 3.0 --ipratio 1.2 --pbratio 1.1 --psy-rd 1.4 --qblur 0.6 --qcomp 0.9 --vbv-init 0.8 --aq-mode 1 --b-adapt 0 --bframes 2 --crf 0 --keyint 290 --lookahead-threads 4 --min-keyint 30 --qp 50 --qpstep 3 --qpmin 4 --qpmax 68 --rc-lookahead 28 --ref 1 --vbv-bufsize 1000 --deblock -2:-2 --me dia --overscan show --preset ultrafast --scenecut 40 --tune animation --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
