...
{ time x264  --no-asm --weightb --aq-strength 0.5 --ipratio 1.5 --pbratio 1.1 --psy-rd 3.4 --qblur 0.5 --qcomp 0.9 --vbv-init 0.0 --aq-mode 0 --b-adapt 0 --bframes 16 --crf 10 --keyint 300 --lookahead-threads 1 --min-keyint 30 --qp 10 --qpstep 4 --qpmin 1 --qpmax 68 --rc-lookahead 48 --ref 2 --vbv-bufsize 2000 --deblock 1:1 --me dia --overscan show --preset veryfast --scenecut 40 --tune ssim --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
