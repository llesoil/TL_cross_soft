...
{ time x264  --aud --constrained-intra --weightb --aq-strength 2.0 --ipratio 1.2 --pbratio 1.3 --psy-rd 2.4 --qblur 0.5 --qcomp 0.6 --vbv-init 0.8 --aq-mode 2 --b-adapt 2 --bframes 6 --crf 5 --keyint 260 --lookahead-threads 2 --min-keyint 21 --qp 20 --qpstep 5 --qpmin 1 --qpmax 61 --rc-lookahead 28 --ref 2 --vbv-bufsize 2000 --deblock 1:1 --me dia --overscan crop --preset veryfast --scenecut 0 --tune ssim --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
