...
{ time x264  --aud --no-weightb --aq-strength 1.5 --ipratio 1.2 --pbratio 1.4 --psy-rd 4.6 --qblur 0.4 --qcomp 0.8 --vbv-init 0.8 --aq-mode 0 --b-adapt 0 --bframes 6 --crf 20 --keyint 290 --lookahead-threads 2 --min-keyint 30 --qp 30 --qpstep 4 --qpmin 4 --qpmax 61 --rc-lookahead 28 --ref 2 --vbv-bufsize 2000 --deblock -2:-2 --me dia --overscan show --preset veryslow --scenecut 10 --tune animation --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
