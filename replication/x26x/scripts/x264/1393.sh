...
{ time x264  --no-asm --no-weightb --aq-strength 2.0 --ipratio 1.4 --pbratio 1.1 --psy-rd 4.6 --qblur 0.2 --qcomp 0.9 --vbv-init 0.3 --aq-mode 1 --b-adapt 1 --bframes 6 --crf 35 --keyint 250 --lookahead-threads 3 --min-keyint 24 --qp 30 --qpstep 3 --qpmin 1 --qpmax 67 --rc-lookahead 38 --ref 5 --vbv-bufsize 1000 --deblock -1:-1 --me umh --overscan crop --preset slower --scenecut 10 --tune grain --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
