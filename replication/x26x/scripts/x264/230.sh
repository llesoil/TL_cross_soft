...
{ time x264  --no-weightb --aq-strength 0.5 --ipratio 1.6 --pbratio 1.0 --psy-rd 2.4 --qblur 0.3 --qcomp 0.9 --vbv-init 0.5 --aq-mode 0 --b-adapt 2 --bframes 16 --crf 10 --keyint 260 --lookahead-threads 4 --min-keyint 27 --qp 20 --qpstep 5 --qpmin 1 --qpmax 68 --rc-lookahead 38 --ref 3 --vbv-bufsize 1000 --deblock -2:-2 --me hex --overscan show --preset medium --scenecut 10 --tune animation --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
