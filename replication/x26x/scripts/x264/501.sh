...
{ time x264  --aud --constrained-intra --no-asm --no-weightb --aq-strength 1.0 --ipratio 1.4 --pbratio 1.0 --psy-rd 2.0 --qblur 0.2 --qcomp 0.8 --vbv-init 0.2 --aq-mode 3 --b-adapt 2 --bframes 6 --crf 45 --keyint 300 --lookahead-threads 2 --min-keyint 21 --qp 50 --qpstep 3 --qpmin 0 --qpmax 64 --rc-lookahead 28 --ref 2 --vbv-bufsize 1000 --deblock 1:1 --me umh --overscan crop --preset slower --scenecut 30 --tune ssim --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
