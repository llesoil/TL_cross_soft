...
{ time x264  --aud --weightb --aq-strength 0.5 --ipratio 1.0 --pbratio 1.0 --psy-rd 2.8 --qblur 0.2 --qcomp 0.6 --vbv-init 0.5 --aq-mode 3 --b-adapt 2 --bframes 10 --crf 35 --keyint 200 --lookahead-threads 4 --min-keyint 20 --qp 50 --qpstep 4 --qpmin 1 --qpmax 65 --rc-lookahead 38 --ref 2 --vbv-bufsize 2000 --deblock -2:-2 --me umh --overscan show --preset superfast --scenecut 30 --tune ssim --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
