...
{ time x264  --no-asm --no-weightb --aq-strength 1.0 --ipratio 1.4 --pbratio 1.0 --psy-rd 3.6 --qblur 0.5 --qcomp 0.6 --vbv-init 0.9 --aq-mode 0 --b-adapt 1 --bframes 4 --crf 35 --keyint 260 --lookahead-threads 1 --min-keyint 20 --qp 30 --qpstep 5 --qpmin 1 --qpmax 69 --rc-lookahead 28 --ref 3 --vbv-bufsize 2000 --deblock -1:-1 --me dia --overscan crop --preset veryslow --scenecut 10 --tune ssim --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
