...
{ time x264  --aud --no-asm --weightb --aq-strength 0.0 --ipratio 1.4 --pbratio 1.0 --psy-rd 3.0 --qblur 0.3 --qcomp 0.9 --vbv-init 0.0 --aq-mode 3 --b-adapt 1 --bframes 0 --crf 5 --keyint 220 --lookahead-threads 0 --min-keyint 27 --qp 30 --qpstep 4 --qpmin 2 --qpmax 67 --rc-lookahead 18 --ref 5 --vbv-bufsize 1000 --deblock -2:-2 --me umh --overscan crop --preset slow --scenecut 40 --tune psnr --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
