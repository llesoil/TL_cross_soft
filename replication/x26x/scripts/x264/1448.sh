...
{ time x264  --aud --no-weightb --aq-strength 2.5 --ipratio 1.3 --pbratio 1.2 --psy-rd 4.2 --qblur 0.6 --qcomp 0.6 --vbv-init 0.0 --aq-mode 0 --b-adapt 0 --bframes 12 --crf 0 --keyint 260 --lookahead-threads 0 --min-keyint 28 --qp 30 --qpstep 3 --qpmin 2 --qpmax 62 --rc-lookahead 48 --ref 1 --vbv-bufsize 2000 --deblock -1:-1 --me umh --overscan crop --preset slower --scenecut 0 --tune grain --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
