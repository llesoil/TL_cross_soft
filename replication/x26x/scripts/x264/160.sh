...
{ time x264  --constrained-intra --slow-firstpass --no-weightb --aq-strength 1.0 --ipratio 1.6 --pbratio 1.2 --psy-rd 1.4 --qblur 0.2 --qcomp 0.9 --vbv-init 0.8 --aq-mode 0 --b-adapt 2 --bframes 8 --crf 5 --keyint 250 --lookahead-threads 1 --min-keyint 20 --qp 30 --qpstep 3 --qpmin 0 --qpmax 67 --rc-lookahead 28 --ref 4 --vbv-bufsize 2000 --deblock -2:-2 --me dia --overscan crop --preset medium --scenecut 10 --tune ssim --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
