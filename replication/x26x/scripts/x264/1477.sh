...
{ time x264  --constrained-intra --no-asm --weightb --aq-strength 2.5 --ipratio 1.0 --pbratio 1.3 --psy-rd 4.4 --qblur 0.3 --qcomp 0.6 --vbv-init 0.3 --aq-mode 2 --b-adapt 0 --bframes 16 --crf 10 --keyint 250 --lookahead-threads 0 --min-keyint 24 --qp 50 --qpstep 4 --qpmin 4 --qpmax 67 --rc-lookahead 38 --ref 3 --vbv-bufsize 2000 --deblock 1:1 --me hex --overscan crop --preset slow --scenecut 40 --tune grain --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
