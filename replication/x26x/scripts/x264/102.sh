...
{ time x264  --constrained-intra --no-weightb --aq-strength 0.0 --ipratio 1.0 --pbratio 1.0 --psy-rd 3.0 --qblur 0.5 --qcomp 0.9 --vbv-init 0.5 --aq-mode 0 --b-adapt 1 --bframes 10 --crf 5 --keyint 270 --lookahead-threads 2 --min-keyint 29 --qp 10 --qpstep 3 --qpmin 1 --qpmax 60 --rc-lookahead 18 --ref 1 --vbv-bufsize 1000 --deblock -2:-2 --me umh --overscan crop --preset fast --scenecut 40 --tune animation --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
