...
{ time x264  --aud --no-asm --weightb --aq-strength 0.5 --ipratio 1.2 --pbratio 1.3 --psy-rd 1.4 --qblur 0.3 --qcomp 0.8 --vbv-init 0.8 --aq-mode 2 --b-adapt 0 --bframes 16 --crf 25 --keyint 200 --lookahead-threads 1 --min-keyint 27 --qp 50 --qpstep 4 --qpmin 0 --qpmax 65 --rc-lookahead 18 --ref 5 --vbv-bufsize 2000 --deblock 1:1 --me hex --overscan crop --preset faster --scenecut 0 --tune animation --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
