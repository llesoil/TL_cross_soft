...
{ time x264  --slow-firstpass --no-weightb --aq-strength 3.0 --ipratio 1.5 --pbratio 1.4 --psy-rd 4.4 --qblur 0.4 --qcomp 0.9 --vbv-init 0.5 --aq-mode 3 --b-adapt 0 --bframes 8 --crf 10 --keyint 220 --lookahead-threads 0 --min-keyint 25 --qp 10 --qpstep 5 --qpmin 1 --qpmax 66 --rc-lookahead 38 --ref 3 --vbv-bufsize 2000 --deblock -2:-2 --me dia --overscan show --preset faster --scenecut 40 --tune ssim --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
