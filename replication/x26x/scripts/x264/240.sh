...
{ time x264  --constrained-intra --weightb --aq-strength 0.0 --ipratio 1.2 --pbratio 1.4 --psy-rd 3.2 --qblur 0.6 --qcomp 0.6 --vbv-init 0.6 --aq-mode 1 --b-adapt 2 --bframes 0 --crf 45 --keyint 260 --lookahead-threads 4 --min-keyint 28 --qp 20 --qpstep 3 --qpmin 1 --qpmax 64 --rc-lookahead 28 --ref 6 --vbv-bufsize 1000 --deblock -2:-2 --me hex --overscan show --preset placebo --scenecut 40 --tune animation --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
