...
{ time x264  --no-asm --slow-firstpass --no-weightb --aq-strength 0.5 --ipratio 1.2 --pbratio 1.4 --psy-rd 0.2 --qblur 0.2 --qcomp 0.8 --vbv-init 0.1 --aq-mode 2 --b-adapt 2 --bframes 8 --crf 50 --keyint 280 --lookahead-threads 4 --min-keyint 24 --qp 50 --qpstep 5 --qpmin 4 --qpmax 67 --rc-lookahead 48 --ref 2 --vbv-bufsize 2000 --deblock -1:-1 --me dia --overscan show --preset medium --scenecut 10 --tune psnr --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
