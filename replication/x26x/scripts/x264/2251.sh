...
{ time x264  --aud --constrained-intra --weightb --aq-strength 0.0 --ipratio 1.1 --pbratio 1.3 --psy-rd 3.8 --qblur 0.6 --qcomp 0.9 --vbv-init 0.2 --aq-mode 0 --b-adapt 1 --bframes 10 --crf 50 --keyint 280 --lookahead-threads 4 --min-keyint 21 --qp 40 --qpstep 3 --qpmin 1 --qpmax 63 --rc-lookahead 38 --ref 3 --vbv-bufsize 1000 --deblock -2:-2 --me hex --overscan crop --preset veryslow --scenecut 30 --tune psnr --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
