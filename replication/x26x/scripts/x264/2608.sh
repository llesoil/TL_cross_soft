...
{ time x264  --constrained-intra --intra-refresh --no-asm --weightb --aq-strength 0.0 --ipratio 1.4 --pbratio 1.1 --psy-rd 2.2 --qblur 0.3 --qcomp 0.9 --vbv-init 0.4 --aq-mode 1 --b-adapt 1 --bframes 2 --crf 10 --keyint 220 --lookahead-threads 2 --min-keyint 22 --qp 20 --qpstep 4 --qpmin 1 --qpmax 63 --rc-lookahead 48 --ref 1 --vbv-bufsize 1000 --deblock 1:1 --me umh --overscan show --preset placebo --scenecut 0 --tune animation --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
