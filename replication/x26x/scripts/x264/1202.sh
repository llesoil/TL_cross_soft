...
{ time x264  --aud --constrained-intra --slow-firstpass --no-weightb --aq-strength 2.5 --ipratio 1.1 --pbratio 1.1 --psy-rd 5.0 --qblur 0.4 --qcomp 0.8 --vbv-init 0.6 --aq-mode 3 --b-adapt 2 --bframes 2 --crf 10 --keyint 220 --lookahead-threads 2 --min-keyint 20 --qp 20 --qpstep 5 --qpmin 1 --qpmax 63 --rc-lookahead 38 --ref 6 --vbv-bufsize 2000 --deblock 1:1 --me umh --overscan crop --preset fast --scenecut 40 --tune animation --output $outputlocation $inputconf $inputlocation ; } 2> $logfilename
